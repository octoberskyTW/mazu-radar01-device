Polymer({ is : "ti-rov-table",
    ...
    cellContextMenu : function (e) {
        ...
        var columnName = e.currentTarget.id;
        if (columnName.indexOf('#') > 0) {
            columnName = columnName.substr(0, columnName.indexOf('#'));
        }
        ...
        if (this.isInstanceView) {
            ...
            if (rovUtils.isArray(this.viewData)) {
                var row = Number(id.substr(id.indexOf('#') + 1));
            ...
            if (rovUtils.isArray(this.viewData)) {
                var instIdx = id.indexOf('#') + 1;
                var rowIdx = id.lastIndexOf('#') + 1;
                var inst = Number(id.substr(instIdx, rowIdx - instIdx - 1));
                var row = Number(id.substr(rowIdx));
                var elemArr = this.viewData[inst].elements;
