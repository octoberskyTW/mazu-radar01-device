...
static inline xdc_Bool xdc_rov_runtime_Monitor_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_rov_runtime_Monitor_Module__diagsMask__C != (CT__xdc_rov_runtime_Monitor_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_rov_runtime_Monitor_Module_getMask(void)
{
    return (xdc_rov_runtime_Monitor_Module__diagsMask__C != (CT__xdc_rov_runtime_Monitor_Module__diagsMask)NULL) ? *xdc_rov_runtime_Monitor_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_rov_runtime_Monitor_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_rov_runtime_Monitor_Module__diagsMask__C != (CT__xdc_rov_runtime_Monitor_Module__diagsMask)NULL) {
