...
public class xdc_rov_runtime
{
    ...
    void $$INITIALIZATION()
    {
        ...
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("xdc.rov.runtime.Monitor", "xdc.rov.runtime");
            Global.put(vo, "rovViewInfo", Global.callFxn("create", (Scriptable)om.find("xdc.rov.ViewInfo"), Global.newObject("argsMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"VariableNameOrAddr", Global.newObject("description", "Variable Name/Address", "args", Global.newArray(new Object[]{Global.newObject("name", "name/addr", "type", "number", "defaultValue", "0"), Global.newObject("name", "check", "type", "boolean", "defaultValue", "true")}))}), Global.newArray(new Object[]{"ReadMemory", Global.newObject("description", "Read Memory", "args", Global.newArray(new Object[]{Global.newObject("name", "addr/name", "type", "number", "defaultValue", "0"), Global.newObject("name", "length", "type", "number", "defaultValue", "0"), Global.newObject("name", "check", "type", "boolean", "defaultValue", "true")}))}), Global.newArray(new Object[]{"FindSymbols", Global.newObject("description", "Find Symbols", "args", Global.newArray(new Object[]{Global.newObject("name", "addr/name", "type", "number", "defaultValue", "0"), Global.newObject("name", "radius", "type", "number", "defaultValue", "0"), Global.newObject("name", "check", "type", "boolean", "defaultValue", "true")}))})}), "viewMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"Module", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE"), "viewInitFxn", "viewInitModule", "structName", "ModuleView")}), Global.newArray(new Object[]{"Variable", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE"), "viewInitFxn", "viewInitVariable", "structName", "VariableView", "argsName", "VariableNameOrAddr")}), Global.newArray(new Object[]{"UChar", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitUChar", "structName", "UCharView", "argsName", "ReadMemory")}), Global.newArray(new Object[]{"Bits16", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitBits16", "structName", "Bits16View", "argsName", "ReadMemory")}), Global.newArray(new Object[]{"Bits32", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitBits32", "structName", "Bits32View", "argsName", "ReadMemory")}), Global.newArray(new Object[]{"Sections", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitSections", "structName", "SectionView")}), Global.newArray(new Object[]{"Symbols", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitSymbols", "structName", "SymbolView", "argsName", "FindSymbols")})}))));
        }//isCFG
