...
public class ti_targets_omf_cof
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.targets.omf.cof$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.targets.omf.cof$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.targets.omf.cof$$stat$root'];\n");
        sb.append("}\n");
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/cof_ti.a86_64U',\n");
            sb.append("'lib/debug/cof_ti.lib',\n");
            sb.append("'lib/release/cof_ti.lib',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/cof_ti.a86_64U', {target: 'gnu.targets.Linux86_64', suffix: '86_64U'}],\n");
            sb.append("['lib/debug/cof_ti.lib', {target: 'microsoft.targets.Win32', suffix: '86W'}],\n");
            sb.append("['lib/release/cof_ti.lib', {target: 'microsoft.targets.Win32', suffix: '86W'}],\n");
        sb.append("];\n");
