...
typedef ti_sysbios_smp_LoggerBuf_Entry *ARRAY1_ti_sysbios_smp_LoggerBuf_Instance_State__entryArr;
typedef const ti_sysbios_smp_LoggerBuf_Entry *CARRAY1_ti_sysbios_smp_LoggerBuf_Instance_State__entryArr;
typedef ARRAY1_ti_sysbios_smp_LoggerBuf_Instance_State__entryArr __TA_ti_sysbios_smp_LoggerBuf_Instance_State__entryArr;
...
struct ti_sysbios_smp_LoggerBuf_Struct {
    ...
    __TA_ti_sysbios_smp_LoggerBuf_Instance_State__entryArr f1;
    ti_sysbios_smp_LoggerBuf_Entry *f2;
    ti_sysbios_smp_LoggerBuf_Entry *f3;
    ti_sysbios_smp_LoggerBuf_Entry *f4;
    xdc_Bits32 f5;
    xdc_Int16 f6;
    xdc_Int8 f7;
    xdc_Bool f8;
...
struct ti_sysbios_smp_LoggerBuf_Fxns__ {
    ...
    xdc_Bool (*enable)(ti_sysbios_smp_LoggerBuf_Handle inst);
    xdc_Bool (*disable)(ti_sysbios_smp_LoggerBuf_Handle inst);
    xdc_Void (*write0)(ti_sysbios_smp_LoggerBuf_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid);
    xdc_Void (*write1)(ti_sysbios_smp_LoggerBuf_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1);
    xdc_Void (*write2)(ti_sysbios_smp_LoggerBuf_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2);
    xdc_Void (*write4)(ti_sysbios_smp_LoggerBuf_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4);
    xdc_Void (*write8)(ti_sysbios_smp_LoggerBuf_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8);
    xdc_Void (*setFilterLevel)(ti_sysbios_smp_LoggerBuf_Handle inst, xdc_runtime_Diags_Mask mask, xdc_runtime_Diags_EventLevel filterLevel);
    xdc_runtime_Diags_Mask (*getFilterLevel)(ti_sysbios_smp_LoggerBuf_Handle inst, xdc_runtime_Diags_EventLevel level);
...
__extern xdc_Int ti_sysbios_smp_LoggerBuf_Instance_init__E(ti_sysbios_smp_LoggerBuf_Object *obj, const ti_sysbios_smp_LoggerBuf_Params *prms, xdc_runtime_Error_Block *eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_Instance_finalize__E, "ti_sysbios_smp_LoggerBuf_Instance_finalize")
__extern void ti_sysbios_smp_LoggerBuf_Instance_finalize__E(ti_sysbios_smp_LoggerBuf_Object *obj, int ec);

/* create */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_create, "ti_sysbios_smp_LoggerBuf_create")
__extern ti_sysbios_smp_LoggerBuf_Handle ti_sysbios_smp_LoggerBuf_create( const ti_sysbios_smp_LoggerBuf_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_construct, "ti_sysbios_smp_LoggerBuf_construct")
__extern void ti_sysbios_smp_LoggerBuf_construct(ti_sysbios_smp_LoggerBuf_Struct *obj, const ti_sysbios_smp_LoggerBuf_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr ti_sysbios_smp_LoggerBuf_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb );
...
static inline ti_sysbios_smp_LoggerBuf_Handle ti_sysbios_smp_LoggerBuf_Handle_downCast(xdc_runtime_IFilterLogger_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&ti_sysbios_smp_LoggerBuf_Module__FXNS__C) ? (ti_sysbios_smp_LoggerBuf_Handle)i : (ti_sysbios_smp_LoggerBuf_Handle)NULL;
}
...
static inline xdc_Bool ti_sysbios_smp_LoggerBuf_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_smp_LoggerBuf_Module__diagsMask__C != (CT__ti_sysbios_smp_LoggerBuf_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_smp_LoggerBuf_Module_getMask(void)
{
    return (ti_sysbios_smp_LoggerBuf_Module__diagsMask__C != (CT__ti_sysbios_smp_LoggerBuf_Module__diagsMask)NULL) ? *ti_sysbios_smp_LoggerBuf_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_smp_LoggerBuf_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_smp_LoggerBuf_Module__diagsMask__C != (CT__ti_sysbios_smp_LoggerBuf_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        ti_sysbios_smp_LoggerBuf_Params__init__S(prms, NULL, sizeof(ti_sysbios_smp_LoggerBuf_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
