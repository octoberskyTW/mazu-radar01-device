...
typedef xdc_Char ARRAY1_ti_sysbios_smp_SysStd_LineBuffer__outbuf[256];
typedef xdc_Char CARRAY1_ti_sysbios_smp_SysStd_LineBuffer__outbuf[256];
typedef CARRAY1_ti_sysbios_smp_SysStd_LineBuffer__outbuf __TA_ti_sysbios_smp_SysStd_LineBuffer__outbuf;
...
typedef ti_sysbios_smp_SysStd_LineBuffer *ARRAY1_ti_sysbios_smp_SysStd_Module_State__lineBuffers;
typedef const ti_sysbios_smp_SysStd_LineBuffer *CARRAY1_ti_sysbios_smp_SysStd_Module_State__lineBuffers;
typedef ARRAY1_ti_sysbios_smp_SysStd_Module_State__lineBuffers __TA_ti_sysbios_smp_SysStd_Module_State__lineBuffers;
...
static inline xdc_Bool ti_sysbios_smp_SysStd_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_smp_SysStd_Module__diagsMask__C != (CT__ti_sysbios_smp_SysStd_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_smp_SysStd_Module_getMask(void)
{
    return (ti_sysbios_smp_SysStd_Module__diagsMask__C != (CT__ti_sysbios_smp_SysStd_Module__diagsMask)NULL) ? *ti_sysbios_smp_SysStd_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_smp_SysStd_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_smp_SysStd_Module__diagsMask__C != (CT__ti_sysbios_smp_SysStd_Module__diagsMask)NULL) {
