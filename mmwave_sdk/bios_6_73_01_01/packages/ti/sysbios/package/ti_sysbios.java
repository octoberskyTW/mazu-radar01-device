...
public class ti_sysbios
{
    ...
    void BIOS$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.BIOS.version", 0x67301L);
    ...
    void BIOS$$TYPES()
    {
        ...
        po.init("ti.sysbios.BIOS.Module", om.findStrict("xdc.runtime.IModule.Module", "ti.sysbios"));
                ...
                po.addFld("version", Proto.Elm.newCNum("(xdc_UInt32)"), 0x67301L, "rh");
        if (isCFG) {
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/ti.sysbios.aearp32F',\n");
            sb.append("'lib/debug/ti.sysbios.ae9',\n");
            sb.append("'lib/debug/ti.sysbios.aea8fnv',\n");
            sb.append("'lib/debug/ti.sysbios.aer5f',\n");
            sb.append("'lib/debug/ti.sysbios.aer4f',\n");
            sb.append("'lib/debug/ti.sysbios.aer4ft',\n");
            sb.append("'lib/debug/ti.sysbios.aem3',\n");
            sb.append("'lib/debug/ti.sysbios.aem4',\n");
            sb.append("'lib/debug/ti.sysbios.aem4f',\n");
            sb.append("'lib/debug/ti.sysbios.am33f',\n");
            sb.append("'lib/debug/ti.sysbios.am3g',\n");
            sb.append("'lib/debug/ti.sysbios.am4g',\n");
            sb.append("'lib/debug/ti.sysbios.am4fg',\n");
            sb.append("'lib/debug/ti.sysbios.am33fg',\n");
            sb.append("'lib/debug/ti.sysbios.aa8fg',\n");
            sb.append("'lib/debug/ti.sysbios.aa9fg',\n");
            sb.append("'lib/debug/ti.sysbios.aa15fg',\n");
            sb.append("'lib/debug/ti.sysbios.aa53fg',\n");
            sb.append("'lib/debug/ti.sysbios.arm3',\n");
            sb.append("'lib/debug/ti.sysbios.arm4',\n");
            sb.append("'lib/debug/ti.sysbios.arm4f',\n");
            sb.append("'lib/debug/ti.sysbios.arm33',\n");
            sb.append("'lib/debug/ti.sysbios.ae71',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.ae28FP', {target: 'ti.targets.elf.C28_float', suffix: 'e28FP'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.ar430XS', {target: 'iar.targets.msp430.MSP430X_small', suffix: 'r430XS'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.aearp32F', {target: 'ti.targets.arp32.elf.ARP32_far', suffix: 'earp32F'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/debug/ti.sysbios.aer4f', {target: 'ti.targets.arm.elf.R4F', suffix: 'er4f'}],\n");
            sb.append("['lib/debug/ti.sysbios.aer4ft', {target: 'ti.targets.arm.elf.R4Ft', suffix: 'er4ft'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.am33f', {target: 'ti.targets.arm.clang.M33F', suffix: 'm33f'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.am33fg', {target: 'gnu.targets.arm.M33F', suffix: 'm33fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.aa8fg', {target: 'gnu.targets.arm.A8F', suffix: 'a8fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.aa9fg', {target: 'gnu.targets.arm.A9F', suffix: 'a9fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.aa15fg', {target: 'gnu.targets.arm.A15F', suffix: 'a15fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.aa53fg', {target: 'gnu.targets.arm.A53F', suffix: 'a53fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.arm3', {target: 'iar.targets.arm.M3', suffix: 'rm3'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.arm33', {target: 'iar.targets.arm.M33', suffix: 'rm33'}],\n");
            sb.append("['lib/debug/ti.sysbios.ae71', {target: 'ti.targets.elf.nda.C71', suffix: 'e71'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
