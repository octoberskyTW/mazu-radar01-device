...
/* TappCallBack */
typedef xdc_Void (*ti_sysbios_io_GIO_TappCallBack)(xdc_Ptr arg1, xdc_Int arg2, xdc_Ptr arg3, xdc_SizeT arg4);
...
struct ti_sysbios_io_GIO_Struct {
    ...
    xdc_UInt f2;
    xdc_UInt f3;
    xdc_runtime_IHeap_Handle f4;
    xdc_runtime_knl_ISync_Handle f5;
    xdc_Bool f6;
    xdc_Bool f7;
    xdc_Ptr f8;
    xdc_Int f9;
    ...
    xdc_Ptr f13;
    xdc_Ptr f14;
    ti_sysbios_knl_Queue_Struct f15;
    ti_sysbios_knl_Queue_Struct f16;
...
__extern xdc_Int ti_sysbios_io_GIO_Instance_init__E(ti_sysbios_io_GIO_Object *obj, xdc_String name, xdc_UInt mode, const ti_sysbios_io_GIO_Params *prms, xdc_runtime_Error_Block *eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_io_GIO_Instance_finalize__E, "ti_sysbios_io_GIO_Instance_finalize")
__extern void ti_sysbios_io_GIO_Instance_finalize__E(ti_sysbios_io_GIO_Object *obj, int ec);

/* create */
xdc__CODESECT(ti_sysbios_io_GIO_create, "ti_sysbios_io_GIO_create")
__extern ti_sysbios_io_GIO_Handle ti_sysbios_io_GIO_create( xdc_String name, xdc_UInt mode, const ti_sysbios_io_GIO_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_io_GIO_construct, "ti_sysbios_io_GIO_construct")
__extern void ti_sysbios_io_GIO_construct(ti_sysbios_io_GIO_Struct *obj, xdc_String name, xdc_UInt mode, const ti_sysbios_io_GIO_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr ti_sysbios_io_GIO_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb );
...
static inline xdc_Bool ti_sysbios_io_GIO_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_io_GIO_Module__diagsMask__C != (CT__ti_sysbios_io_GIO_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_io_GIO_Module_getMask(void)
{
    return (ti_sysbios_io_GIO_Module__diagsMask__C != (CT__ti_sysbios_io_GIO_Module__diagsMask)NULL) ? *ti_sysbios_io_GIO_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_io_GIO_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_io_GIO_Module__diagsMask__C != (CT__ti_sysbios_io_GIO_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        ti_sysbios_io_GIO_Params__init__S(prms, NULL, sizeof(ti_sysbios_io_GIO_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
