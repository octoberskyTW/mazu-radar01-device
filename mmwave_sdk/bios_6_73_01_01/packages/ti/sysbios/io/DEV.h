...
typedef ti_sysbios_io_DEV_Handle *ARRAY1_ti_sysbios_io_DEV_Module_State__table;
typedef const ti_sysbios_io_DEV_Handle *CARRAY1_ti_sysbios_io_DEV_Module_State__table;
typedef ARRAY1_ti_sysbios_io_DEV_Module_State__table __TA_ti_sysbios_io_DEV_Module_State__table;
...
struct ti_sysbios_io_DEV_Struct {
    xdc_String f0;
    ti_sysbios_io_DEV_Fxns *f1;
    ti_sysbios_io_DEV_InitFxn f2;
    xdc_Int f3;
    ti_sysbios_io_DEV_DeviceParams *f4;
    xdc_Ptr f5;
...
__extern xdc_Int ti_sysbios_io_DEV_Instance_init__E(ti_sysbios_io_DEV_Object *obj, xdc_String name, xdc_Ptr fxns, const ti_sysbios_io_DEV_Params *prms, xdc_runtime_Error_Block *eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_io_DEV_Instance_finalize__E, "ti_sysbios_io_DEV_Instance_finalize")
__extern void ti_sysbios_io_DEV_Instance_finalize__E(ti_sysbios_io_DEV_Object *obj, int ec);

/* create */
xdc__CODESECT(ti_sysbios_io_DEV_create, "ti_sysbios_io_DEV_create")
__extern ti_sysbios_io_DEV_Handle ti_sysbios_io_DEV_create( xdc_String name, xdc_Ptr fxns, const ti_sysbios_io_DEV_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_io_DEV_construct, "ti_sysbios_io_DEV_construct")
__extern void ti_sysbios_io_DEV_construct(ti_sysbios_io_DEV_Struct *obj, xdc_String name, xdc_Ptr fxns, const ti_sysbios_io_DEV_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr ti_sysbios_io_DEV_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb );
...
static inline xdc_Bool ti_sysbios_io_DEV_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_io_DEV_Module__diagsMask__C != (CT__ti_sysbios_io_DEV_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_io_DEV_Module_getMask(void)
{
    return (ti_sysbios_io_DEV_Module__diagsMask__C != (CT__ti_sysbios_io_DEV_Module__diagsMask)NULL) ? *ti_sysbios_io_DEV_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_io_DEV_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_io_DEV_Module__diagsMask__C != (CT__ti_sysbios_io_DEV_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        ti_sysbios_io_DEV_Params__init__S(prms, NULL, sizeof(ti_sysbios_io_DEV_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
