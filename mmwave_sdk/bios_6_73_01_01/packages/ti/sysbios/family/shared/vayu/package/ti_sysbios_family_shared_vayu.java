...
public class ti_sysbios_family_shared_vayu
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.shared.vayu.aearp32',\n");
            sb.append("'lib/debug/ti.sysbios.family.shared.vayu.aearp32F',\n");
            sb.append("'lib/debug/ti.sysbios.family.shared.vayu.ae66',\n");
            sb.append("'lib/debug/ti.sysbios.family.shared.vayu.ae66e',\n");
            sb.append("'lib/debug/ti.sysbios.family.shared.vayu.aa15fg',\n");
            sb.append("'lib/debug/ti.sysbios.family.shared.vayu.aem4',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.shared.vayu.aearp32', {target: 'ti.targets.arp32.elf.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.shared.vayu.aearp32F', {target: 'ti.targets.arp32.elf.ARP32_far', suffix: 'earp32F'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.shared.vayu.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.shared.vayu.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.shared.vayu.aa15fg', {target: 'gnu.targets.arm.A15F', suffix: 'a15fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.shared.vayu.aem4', {target: 'ti.targets.arm.elf.M4', suffix: 'em4'}],\n");
        sb.append("];\n");
