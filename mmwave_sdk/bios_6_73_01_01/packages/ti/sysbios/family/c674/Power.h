...
typedef ti_sysbios_knl_Queue_Instance_State *ARRAY1_ti_sysbios_family_c674_Power_Module_State__notifyQ;
typedef const ti_sysbios_knl_Queue_Instance_State *CARRAY1_ti_sysbios_family_c674_Power_Module_State__notifyQ;
typedef ARRAY1_ti_sysbios_family_c674_Power_Module_State__notifyQ __TA_ti_sysbios_family_c674_Power_Module_State__notifyQ;
...
static inline xdc_Bool ti_sysbios_family_c674_Power_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_c674_Power_Module__diagsMask__C != (CT__ti_sysbios_family_c674_Power_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_c674_Power_Module_getMask(void)
{
    return (ti_sysbios_family_c674_Power_Module__diagsMask__C != (CT__ti_sysbios_family_c674_Power_Module__diagsMask)NULL) ? *ti_sysbios_family_c674_Power_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_c674_Power_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_c674_Power_Module__diagsMask__C != (CT__ti_sysbios_family_c674_Power_Module__diagsMask)NULL) {
...
#endif
static inline ti_sysbios_knl_Queue_Handle ti_sysbios_family_c674_Power_Module_State_constraintsQ(void);
static inline ti_sysbios_knl_Queue_Handle ti_sysbios_family_c674_Power_Module_State_constraintsQ(void)
{
