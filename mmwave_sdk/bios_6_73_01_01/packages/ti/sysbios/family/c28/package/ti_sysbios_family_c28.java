...
public class ti_sysbios_family_c28
{
    ...
    void Settings$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                if (fxn != null) po.addFxn("getDefaultSysCallDelegate", (Proto.Fxn)om.findStrict("ti.sysbios.interfaces.ISettings$$getDefaultSysCallDelegate", "ti.sysbios.family.c28"), fxn);
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.c28.ae28FP',\n");
            sb.append("'lib/debug/ti.sysbios.family.c28.a28L',\n");
            sb.append("'lib/debug/ti.sysbios.family.c28.a28FP',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.c28.ae28FP', {target: 'ti.targets.elf.C28_float', suffix: 'e28FP'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c28.a28L', {target: 'ti.targets.C28_large', suffix: '28L'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c28.a28FP', {target: 'ti.targets.C28_float', suffix: '28FP'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
