...
typedef xdc_Char ARRAY1_ti_sysbios_family_c64p_Exception_Module_State__scratch[16];
typedef xdc_Char CARRAY1_ti_sysbios_family_c64p_Exception_Module_State__scratch[16];
typedef ARRAY1_ti_sysbios_family_c64p_Exception_Module_State__scratch __TA_ti_sysbios_family_c64p_Exception_Module_State__scratch;
typedef xdc_Char __T1_ti_sysbios_family_c64p_Exception_Module_State__contextBuf;
typedef xdc_Char *ARRAY1_ti_sysbios_family_c64p_Exception_Module_State__contextBuf;
typedef const xdc_Char *CARRAY1_ti_sysbios_family_c64p_Exception_Module_State__contextBuf;
typedef ARRAY1_ti_sysbios_family_c64p_Exception_Module_State__contextBuf __TA_ti_sysbios_family_c64p_Exception_Module_State__contextBuf;
...
static inline xdc_Bool ti_sysbios_family_c64p_Exception_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_c64p_Exception_Module__diagsMask__C != (CT__ti_sysbios_family_c64p_Exception_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_c64p_Exception_Module_getMask(void)
{
    return (ti_sysbios_family_c64p_Exception_Module__diagsMask__C != (CT__ti_sysbios_family_c64p_Exception_Module__diagsMask)NULL) ? *ti_sysbios_family_c64p_Exception_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_c64p_Exception_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_c64p_Exception_Module__diagsMask__C != (CT__ti_sysbios_family_c64p_Exception_Module__diagsMask)NULL) {
