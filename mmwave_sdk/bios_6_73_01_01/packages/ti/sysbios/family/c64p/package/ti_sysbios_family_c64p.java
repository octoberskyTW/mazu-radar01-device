...
public class ti_sysbios_family_c64p
{
    ...
    void EventCombiner$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.sysbios.family.c64p.EventCombiner$$Registers", new Proto.Obj());
        om.bind("ti.sysbios.family.c64p.EventCombiner.Registers", new Proto.Str(spo, false));
    ...
    void EventCombiner$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.sysbios.family.c64p.EventCombiner.Registers", "ti.sysbios.family.c64p");
        sizes.clear();
        sizes.add(Global.newArray("EVTFLAG", "A4;UInt"));
        sizes.add(Global.newArray("hole1", "A4;UInt"));
        sizes.add(Global.newArray("EVTSET", "A4;UInt"));
        sizes.add(Global.newArray("hole2", "A4;UInt"));
        sizes.add(Global.newArray("EVTCLR", "A4;UInt"));
        sizes.add(Global.newArray("hole3", "A12;UInt"));
        sizes.add(Global.newArray("EVTMASK", "A4;UInt"));
        sizes.add(Global.newArray("hole4", "A4;UInt"));
        sizes.add(Global.newArray("MEVTFLAG", "A4;UInt"));
        sizes.add(Global.newArray("hole5", "A4;UInt"));
        sizes.add(Global.newArray("EXPMASK", "A4;UInt"));
        sizes.add(Global.newArray("hole6", "A4;UInt"));
        sizes.add(Global.newArray("MEXPMASK", "A4;UInt"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.family.c64p.EventCombiner.Registers']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.family.c64p.EventCombiner.Registers']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.family.c64p.EventCombiner.Registers'], fld); }");
    ...
    void EventCombiner$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("EVTRegs", new Proto.Adr("ti_sysbios_family_c64p_EventCombiner_Registers*", "PS"), 0x01800000L, "w");
        ...
        // struct EventCombiner.Registers
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.c64p.EventCombiner$$Registers", "ti.sysbios.family.c64p");
        po.init("ti.sysbios.family.c64p.EventCombiner.Registers", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("EVTFLAG", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("hole1", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("EVTSET", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("hole2", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("EVTCLR", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("hole3", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(12L)), $$DEFAULT, "w");
                po.addFld("EVTMASK", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("hole4", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("MEVTFLAG", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("hole5", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("EXPMASK", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("hole6", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
                po.addFld("MEXPMASK", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt)"), false, xdc.services.intern.xsr.Enum.intValue(4L)), $$DEFAULT, "w");
    ...
    void Hwi$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("INTRMUX1Address", new Proto.Adr("xdc_Ptr", "Pv"), 0x01800104L, "w");
    ...
    void Settings$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                if (fxn != null) po.addFxn("getDefaultSysCallDelegate", (Proto.Fxn)om.findStrict("ti.sysbios.interfaces.ISettings$$getDefaultSysCallDelegate", "ti.sysbios.family.c64p"), fxn);
    ...
    void EventCombiner$$ROV()
    {
        ...
        vo.bind("Registers$fetchDesc", Global.newObject("type", "ti.sysbios.family.c64p.EventCombiner.Registers", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.c64p.EventCombiner$$Registers", "ti.sysbios.family.c64p");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.ae66',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.ae66e',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void EventCombiner$$SINGLETONS()
    {
        ...
        vo.bind("Registers", om.findStrict("ti.sysbios.family.c64p.EventCombiner.Registers", "ti.sysbios.family.c64p"));
        tdefs.add(om.findStrict("ti.sysbios.family.c64p.EventCombiner.Registers", "ti.sysbios.family.c64p"));
        mcfgs.add("EVTRegs");
