...
typedef xdc_UInt32 ARRAY1_ti_sysbios_family_c66_Cache_marvalues[256];
typedef xdc_UInt32 CARRAY1_ti_sysbios_family_c66_Cache_marvalues[256];
typedef CARRAY1_ti_sysbios_family_c66_Cache_marvalues __TA_ti_sysbios_family_c66_Cache_marvalues;
typedef CARRAY1_ti_sysbios_family_c66_Cache_marvalues CT__ti_sysbios_family_c66_Cache_marvalues;
...
static inline xdc_Bool ti_sysbios_family_c66_Cache_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_c66_Cache_Module__diagsMask__C != (CT__ti_sysbios_family_c66_Cache_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_c66_Cache_Module_getMask(void)
{
    return (ti_sysbios_family_c66_Cache_Module__diagsMask__C != (CT__ti_sysbios_family_c66_Cache_Module__diagsMask)NULL) ? *ti_sysbios_family_c66_Cache_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_c66_Cache_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_c66_Cache_Module__diagsMask__C != (CT__ti_sysbios_family_c66_Cache_Module__diagsMask)NULL) {
