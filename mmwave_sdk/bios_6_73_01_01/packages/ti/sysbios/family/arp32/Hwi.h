...
typedef xdc_Ptr *ARRAY1_ti_sysbios_family_arp32_Hwi_Instance_State__hookEnv;
typedef const xdc_Ptr *CARRAY1_ti_sysbios_family_arp32_Hwi_Instance_State__hookEnv;
typedef ARRAY1_ti_sysbios_family_arp32_Hwi_Instance_State__hookEnv __TA_ti_sysbios_family_arp32_Hwi_Instance_State__hookEnv;

/* Module_State */
typedef xdc_Bits32 __T1_ti_sysbios_family_arp32_Hwi_Module_State__interruptMask;
typedef xdc_Bits32 *ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__interruptMask;
typedef const xdc_Bits32 *CARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__interruptMask;
typedef ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__interruptMask __TA_ti_sysbios_family_arp32_Hwi_Module_State__interruptMask;
typedef xdc_Bits16 __T1_ti_sysbios_family_arp32_Hwi_Module_State__disableIerMask;
typedef xdc_Bits16 *ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__disableIerMask;
typedef const xdc_Bits16 *CARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__disableIerMask;
typedef ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__disableIerMask __TA_ti_sysbios_family_arp32_Hwi_Module_State__disableIerMask;
typedef xdc_Bits16 __T1_ti_sysbios_family_arp32_Hwi_Module_State__restoreIerMask;
typedef xdc_Bits16 *ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__restoreIerMask;
typedef const xdc_Bits16 *CARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__restoreIerMask;
typedef ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__restoreIerMask __TA_ti_sysbios_family_arp32_Hwi_Module_State__restoreIerMask;
typedef ti_sysbios_family_arp32_Hwi_Irp __T1_ti_sysbios_family_arp32_Hwi_Module_State__irp;
typedef ti_sysbios_family_arp32_Hwi_Irp *ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__irp;
typedef const ti_sysbios_family_arp32_Hwi_Irp *CARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__irp;
typedef ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__irp __TA_ti_sysbios_family_arp32_Hwi_Module_State__irp;
typedef ti_sysbios_family_arp32_Hwi_Handle __T1_ti_sysbios_family_arp32_Hwi_Module_State__dispatchTable;
typedef ti_sysbios_family_arp32_Hwi_Handle *ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__dispatchTable;
typedef const ti_sysbios_family_arp32_Hwi_Handle *CARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__dispatchTable;
typedef ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__dispatchTable __TA_ti_sysbios_family_arp32_Hwi_Module_State__dispatchTable;
...
typedef ti_sysbios_family_arp32_Hwi_IntcRegs *ARRAY1_ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDRS[4];
typedef ti_sysbios_family_arp32_Hwi_IntcRegs *CARRAY1_ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDRS[4];
typedef CARRAY1_ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDRS __TA_ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDRS;
typedef CARRAY1_ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDRS CT__ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDRS;
...
/* swiRestoreHwi */
typedef xdc_Void (*CT__ti_sysbios_family_arp32_Hwi_swiRestoreHwi)(xdc_UInt arg1);
...
/* taskRestoreHwi */
typedef xdc_Void (*CT__ti_sysbios_family_arp32_Hwi_taskRestoreHwi)(xdc_UInt arg1);
...
typedef struct { int length; ti_sysbios_family_arp32_Hwi_HookSet *elem; } ARRAY1_ti_sysbios_family_arp32_Hwi_hooks;
typedef struct { int length; ti_sysbios_family_arp32_Hwi_HookSet const *elem; } CARRAY1_ti_sysbios_family_arp32_Hwi_hooks;
typedef CARRAY1_ti_sysbios_family_arp32_Hwi_hooks __TA_ti_sysbios_family_arp32_Hwi_hooks;
typedef CARRAY1_ti_sysbios_family_arp32_Hwi_hooks CT__ti_sysbios_family_arp32_Hwi_hooks;
...
struct ti_sysbios_family_arp32_Hwi_Struct {
    ...
    xdc_UInt f4;
    xdc_UArg f5;
    ti_sysbios_family_arp32_Hwi_FuncPtr f6;
    ti_sysbios_family_arp32_Hwi_Irp f7;
    __TA_ti_sysbios_family_arp32_Hwi_Instance_State__hookEnv f8;
...
struct ti_sysbios_family_arp32_Hwi_Fxns__ {
    ...
    ti_sysbios_interfaces_IHwi_FuncPtr (*getFunc)(ti_sysbios_family_arp32_Hwi_Handle inst, xdc_UArg* arg);
    xdc_Void (*setFunc)(ti_sysbios_family_arp32_Hwi_Handle inst, ti_sysbios_interfaces_IHwi_FuncPtr fxn, xdc_UArg arg);
    xdc_Ptr (*getHookContext)(ti_sysbios_family_arp32_Hwi_Handle inst, xdc_Int id);
    xdc_Void (*setHookContext)(ti_sysbios_family_arp32_Hwi_Handle inst, xdc_Int id, xdc_Ptr hookContext);
    ti_sysbios_interfaces_IHwi_Irp (*getIrp)(ti_sysbios_family_arp32_Hwi_Handle inst);
...
__extern xdc_Int ti_sysbios_family_arp32_Hwi_Instance_init__E(ti_sysbios_family_arp32_Hwi_Object *obj, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arp32_Hwi_Params *prms, xdc_runtime_Error_Block *eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_family_arp32_Hwi_Instance_finalize__E, "ti_sysbios_family_arp32_Hwi_Instance_finalize")
__extern void ti_sysbios_family_arp32_Hwi_Instance_finalize__E(ti_sysbios_family_arp32_Hwi_Object *obj, int ec);

/* create */
xdc__CODESECT(ti_sysbios_family_arp32_Hwi_create, "ti_sysbios_family_arp32_Hwi_create")
__extern ti_sysbios_family_arp32_Hwi_Handle ti_sysbios_family_arp32_Hwi_create( xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arp32_Hwi_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_family_arp32_Hwi_construct, "ti_sysbios_family_arp32_Hwi_construct")
__extern void ti_sysbios_family_arp32_Hwi_construct(ti_sysbios_family_arp32_Hwi_Struct *obj, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arp32_Hwi_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr ti_sysbios_family_arp32_Hwi_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb );
...
static inline ti_sysbios_family_arp32_Hwi_Handle ti_sysbios_family_arp32_Hwi_Handle_downCast(ti_sysbios_interfaces_IHwi_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&ti_sysbios_family_arp32_Hwi_Module__FXNS__C) ? (ti_sysbios_family_arp32_Hwi_Handle)i : (ti_sysbios_family_arp32_Hwi_Handle)NULL;
}
...
static inline xdc_Bool ti_sysbios_family_arp32_Hwi_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_arp32_Hwi_Module__diagsMask__C != (CT__ti_sysbios_family_arp32_Hwi_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arp32_Hwi_Module_getMask(void)
{
    return (ti_sysbios_family_arp32_Hwi_Module__diagsMask__C != (CT__ti_sysbios_family_arp32_Hwi_Module__diagsMask)NULL) ? *ti_sysbios_family_arp32_Hwi_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arp32_Hwi_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arp32_Hwi_Module__diagsMask__C != (CT__ti_sysbios_family_arp32_Hwi_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        ti_sysbios_family_arp32_Hwi_Params__init__S(prms, NULL, sizeof(ti_sysbios_family_arp32_Hwi_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
