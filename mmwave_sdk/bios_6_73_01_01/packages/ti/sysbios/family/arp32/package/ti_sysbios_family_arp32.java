...
public class ti_sysbios_family_arp32
{
    ...
    void Settings$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                if (fxn != null) po.addFxn("getDefaultSysCallDelegate", (Proto.Fxn)om.findStrict("ti.sysbios.interfaces.ISettings$$getDefaultSysCallDelegate", "ti.sysbios.family.arp32"), fxn);
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.arp32.aearp32',\n");
            sb.append("'lib/debug/ti.sysbios.family.arp32.aearp32F',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arp32.aearp32', {target: 'ti.targets.arp32.elf.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arp32.aearp32F', {target: 'ti.targets.arp32.elf.ARP32_far', suffix: 'earp32F'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
