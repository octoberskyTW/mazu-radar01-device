...
static inline xdc_Bool ti_sysbios_family_arm_v7r_Cache_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_arm_v7r_Cache_Module__diagsMask__C != (CT__ti_sysbios_family_arm_v7r_Cache_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_v7r_Cache_Module_getMask(void)
{
    return (ti_sysbios_family_arm_v7r_Cache_Module__diagsMask__C != (CT__ti_sysbios_family_arm_v7r_Cache_Module__diagsMask)NULL) ? *ti_sysbios_family_arm_v7r_Cache_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_v7r_Cache_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_v7r_Cache_Module__diagsMask__C != (CT__ti_sysbios_family_arm_v7r_Cache_Module__diagsMask)NULL) {
...
struct ti_sysbios_family_arm_v7r_Cache_Module_State {
    xdc_UInt32 l1dCacheLineSize;
    xdc_UInt32 l1pCacheLineSize;
    xdc_Bits32 l1dInfo;
    xdc_Bits32 l1pInfo;
};
