...
public class ti_sysbios_family_arm_v7r
{
    ...
    void Cache$$SIZES()
    {
        ...
        sizes.clear();
        sizes.add(Global.newArray("l1dCacheLineSize", "UInt32"));
        sizes.add(Global.newArray("l1pCacheLineSize", "UInt32"));
    ...
    void Cache$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arm.v7r.Cache.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("l1dCacheLineSize", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("l1pCacheLineSize", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7r.aer5f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7r.aer4f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7r.aer4ft',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7r.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7r.aer4f', {target: 'ti.targets.arm.elf.R4F', suffix: 'er4f'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7r.aer4ft', {target: 'ti.targets.arm.elf.R4Ft', suffix: 'er4ft'}],\n");
        sb.append("];\n");
