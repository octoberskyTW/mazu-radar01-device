...
public class ti_sysbios_family_arm_v7r_keystone3
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7r.keystone3.aer5f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7r.keystone3.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
