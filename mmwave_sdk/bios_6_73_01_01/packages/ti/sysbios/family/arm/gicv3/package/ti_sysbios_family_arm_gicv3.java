...
public class ti_sysbios_family_arm_gicv3
{
    ...
    {
        // module Hwi
        om.bind("ti.sysbios.family.arm.gicv3.Hwi.NUM_INTERRUPTS", 992L);
    ...
    void Hwi$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arm.gicv3.Hwi.Module", om.findStrict("ti.sysbios.interfaces.IHwi.Module", "ti.sysbios.family.arm.gicv3"));
                ...
                po.addFld("NUM_INTERRUPTS", Proto.Elm.newCNum("(xdc_UInt)"), 992L, "rh");
        if (isCFG) {
            ...
            po.addFld("E_exception", (Proto)om.findStrict("xdc.runtime.Error$$Id", "ti.sysbios.family.arm.gicv3"), Global.newObject("msg", "E_exception: A hardware exception has occurred."), "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.gicv3.aa53fg',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.gicv3.aa53fg', {target: 'gnu.targets.arm.A53F', suffix: 'a53fg'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void Hwi$$SINGLETONS()
    {
        ...
        vo.bind("$$errorDescCfgs", Global.newArray("E_alreadyDefined", "E_handleNotFound", "E_undefined", "E_badIntNum", "E_exception"));
