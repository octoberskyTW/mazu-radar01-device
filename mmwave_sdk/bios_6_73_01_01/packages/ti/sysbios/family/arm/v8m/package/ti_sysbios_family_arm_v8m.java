...
public class ti_sysbios_family_arm_v8m
{
    ...
    void Hwi$$SIZES()
    {
        ...
        sizes.add(Global.newArray("RES_340", "A48;UInt32"));
    ...
    void Hwi$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arm.v8m.Hwi.NVIC", null);
                ...
                po.addFld("RES_340", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt32)"), false, xdc.services.intern.xsr.Enum.intValue(48L)), $$DEFAULT, "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v8m.am33f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v8m.am33fg',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v8m.arm33',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v8m.am33f', {target: 'ti.targets.arm.clang.M33F', suffix: 'm33f'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v8m.am33fg', {target: 'gnu.targets.arm.M33F', suffix: 'm33fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v8m.arm33', {target: 'iar.targets.arm.M33', suffix: 'rm33'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
