...
public class ti_sysbios_family_arm_v8m_mtl
{
    ...
    void Timer$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.v8m.mtl.Timer.dynamicStub", new Extern("ti_sysbios_family_arm_v8m_mtl_Timer_dynamicStub__E", "xdc_Void(*)(xdc_UArg)", true, false));
        om.bind("ti.sysbios.family.arm.v8m.mtl.Timer.dynamicMultiStub", new Extern("ti_sysbios_family_arm_v8m_mtl_Timer_dynamicMultiStub__E", "xdc_Void(*)(xdc_UArg)", true, false));
        ...
        om.bind("ti.sysbios.family.arm.v8m.mtl.Timer.getCount64", new Extern("ti_sysbios_family_arm_v8m_mtl_Timer_getCount64__E", "xdc_UInt64(*)(ti_sysbios_family_arm_v8m_mtl_Timer_Object*)", true, false));
        om.bind("ti.sysbios.family.arm.v8m.mtl.Timer.getExpiredCounts64", new Extern("ti_sysbios_family_arm_v8m_mtl_Timer_getExpiredCounts64__E", "xdc_UInt64(*)(ti_sysbios_family_arm_v8m_mtl_Timer_Object*)", true, false));
    ...
    void Timer$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arm.v8m.mtl.Timer.Instance_State", null);
                ...
                po.addFld("frequency", (Proto)om.findStrict("xdc.runtime.Types.FreqHz", "ti.sysbios.family.arm.v8m.mtl"), $$DEFAULT, "w");
        ...
        po.init("ti.sysbios.family.arm.v8m.mtl.Timer.Module_State", null);
                ...
                po.addFld("handle", (Proto)om.findStrict("ti.sysbios.family.arm.v8m.mtl.Timer.Handle", "ti.sysbios.family.arm.v8m.mtl"), $$UNDEF, "w");
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v8m.mtl.am33f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v8m.mtl.am33fg',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v8m.mtl.arm33',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v8m.mtl.am33f', {target: 'ti.targets.arm.clang.M33F', suffix: 'm33f'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v8m.mtl.am33fg', {target: 'gnu.targets.arm.M33F', suffix: 'm33fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v8m.mtl.arm33', {target: 'iar.targets.arm.M33', suffix: 'rm33'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void Timer$$SINGLETONS()
    {
        ...
        vo.bind("dynamicStub", om.findStrict("ti.sysbios.family.arm.v8m.mtl.Timer.dynamicStub", "ti.sysbios.family.arm.v8m.mtl"));
        vo.bind("dynamicMultiStub", om.findStrict("ti.sysbios.family.arm.v8m.mtl.Timer.dynamicMultiStub", "ti.sysbios.family.arm.v8m.mtl"));
        vo.bind("periodicStub", om.findStrict("ti.sysbios.family.arm.v8m.mtl.Timer.periodicStub", "ti.sysbios.family.arm.v8m.mtl"));
        vo.bind("getCount64", om.findStrict("ti.sysbios.family.arm.v8m.mtl.Timer.getCount64", "ti.sysbios.family.arm.v8m.mtl"));
        vo.bind("getExpiredCounts64", om.findStrict("ti.sysbios.family.arm.v8m.mtl.Timer.getExpiredCounts64", "ti.sysbios.family.arm.v8m.mtl"));
