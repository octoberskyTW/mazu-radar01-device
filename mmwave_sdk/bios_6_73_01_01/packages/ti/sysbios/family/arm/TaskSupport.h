...
__extern xdc_Ptr ti_sysbios_family_arm_TaskSupport_start__E( xdc_Ptr curTask, ti_sysbios_interfaces_ITaskSupport_FuncPtr enterFxn, ti_sysbios_interfaces_ITaskSupport_FuncPtr exitFxn, xdc_runtime_Error_Block *eb );
...
static inline xdc_Bool ti_sysbios_family_arm_TaskSupport_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_arm_TaskSupport_Module__diagsMask__C != (CT__ti_sysbios_family_arm_TaskSupport_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_TaskSupport_Module_getMask(void)
{
    return (ti_sysbios_family_arm_TaskSupport_Module__diagsMask__C != (CT__ti_sysbios_family_arm_TaskSupport_Module__diagsMask)NULL) ? *ti_sysbios_family_arm_TaskSupport_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_TaskSupport_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_TaskSupport_Module__diagsMask__C != (CT__ti_sysbios_family_arm_TaskSupport_Module__diagsMask)NULL) {
