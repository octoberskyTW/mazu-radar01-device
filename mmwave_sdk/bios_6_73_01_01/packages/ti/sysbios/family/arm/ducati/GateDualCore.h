...
typedef xdc_UInt8 ARRAY1_ti_sysbios_family_arm_ducati_GateDualCore_Module_State__usedGates[4];
typedef xdc_UInt8 CARRAY1_ti_sysbios_family_arm_ducati_GateDualCore_Module_State__usedGates[4];
typedef ARRAY1_ti_sysbios_family_arm_ducati_GateDualCore_Module_State__usedGates __TA_ti_sysbios_family_arm_ducati_GateDualCore_Module_State__usedGates;
...
struct ti_sysbios_family_arm_ducati_GateDualCore_Struct {
    ...
    xdc_UInt f0;
    volatile xdc_UInt32 *f1;
    volatile xdc_UInt8 *f2;
    xdc_UInt f3;
    xdc_UInt f4;
    xdc_UInt f5;
    xdc_UInt f6;
...
struct ti_sysbios_family_arm_ducati_GateDualCore_Fxns__ {
    ...
    xdc_IArg (*enter)(ti_sysbios_family_arm_ducati_GateDualCore_Handle inst);
    xdc_Void (*leave)(ti_sysbios_family_arm_ducati_GateDualCore_Handle inst, xdc_IArg key);
...
__extern xdc_Int ti_sysbios_family_arm_ducati_GateDualCore_Instance_init__E(ti_sysbios_family_arm_ducati_GateDualCore_Object *obj, const ti_sysbios_family_arm_ducati_GateDualCore_Params *prms, xdc_runtime_Error_Block *eb);

/* create */
xdc__CODESECT(ti_sysbios_family_arm_ducati_GateDualCore_create, "ti_sysbios_family_arm_ducati_GateDualCore_create")
__extern ti_sysbios_family_arm_ducati_GateDualCore_Handle ti_sysbios_family_arm_ducati_GateDualCore_create( const ti_sysbios_family_arm_ducati_GateDualCore_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_family_arm_ducati_GateDualCore_construct, "ti_sysbios_family_arm_ducati_GateDualCore_construct")
__extern void ti_sysbios_family_arm_ducati_GateDualCore_construct(ti_sysbios_family_arm_ducati_GateDualCore_Struct *obj, const ti_sysbios_family_arm_ducati_GateDualCore_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr ti_sysbios_family_arm_ducati_GateDualCore_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb );
...
static inline ti_sysbios_family_arm_ducati_GateDualCore_Handle ti_sysbios_family_arm_ducati_GateDualCore_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&ti_sysbios_family_arm_ducati_GateDualCore_Module__FXNS__C) ? (ti_sysbios_family_arm_ducati_GateDualCore_Handle)i : (ti_sysbios_family_arm_ducati_GateDualCore_Handle)NULL;
}
...
static inline xdc_Bool ti_sysbios_family_arm_ducati_GateDualCore_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_arm_ducati_GateDualCore_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_GateDualCore_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_ducati_GateDualCore_Module_getMask(void)
{
    return (ti_sysbios_family_arm_ducati_GateDualCore_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_GateDualCore_Module__diagsMask)NULL) ? *ti_sysbios_family_arm_ducati_GateDualCore_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_ducati_GateDualCore_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_ducati_GateDualCore_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_GateDualCore_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        ti_sysbios_family_arm_ducati_GateDualCore_Params__init__S(prms, NULL, sizeof(ti_sysbios_family_arm_ducati_GateDualCore_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
