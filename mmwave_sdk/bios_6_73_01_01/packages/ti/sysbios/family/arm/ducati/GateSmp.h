...
struct ti_sysbios_family_arm_ducati_GateSmp_Fxns__ {
    ...
    xdc_IArg (*enter)(ti_sysbios_family_arm_ducati_GateSmp_Handle inst);
    xdc_Void (*leave)(ti_sysbios_family_arm_ducati_GateSmp_Handle inst, xdc_IArg key);
...
__extern xdc_Void ti_sysbios_family_arm_ducati_GateSmp_Instance_init__E(ti_sysbios_family_arm_ducati_GateSmp_Object *obj, const ti_sysbios_family_arm_ducati_GateSmp_Params *prms);

/* create */
xdc__CODESECT(ti_sysbios_family_arm_ducati_GateSmp_create, "ti_sysbios_family_arm_ducati_GateSmp_create")
__extern ti_sysbios_family_arm_ducati_GateSmp_Handle ti_sysbios_family_arm_ducati_GateSmp_create( const ti_sysbios_family_arm_ducati_GateSmp_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_family_arm_ducati_GateSmp_construct, "ti_sysbios_family_arm_ducati_GateSmp_construct")
__extern void ti_sysbios_family_arm_ducati_GateSmp_construct(ti_sysbios_family_arm_ducati_GateSmp_Struct *obj, const ti_sysbios_family_arm_ducati_GateSmp_Params *prms);
...
__extern xdc_Ptr ti_sysbios_family_arm_ducati_GateSmp_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb );
...
static inline ti_sysbios_family_arm_ducati_GateSmp_Handle ti_sysbios_family_arm_ducati_GateSmp_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&ti_sysbios_family_arm_ducati_GateSmp_Module__FXNS__C) ? (ti_sysbios_family_arm_ducati_GateSmp_Handle)i : (ti_sysbios_family_arm_ducati_GateSmp_Handle)NULL;
}
...
static inline xdc_Bool ti_sysbios_family_arm_ducati_GateSmp_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_arm_ducati_GateSmp_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_GateSmp_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_ducati_GateSmp_Module_getMask(void)
{
    return (ti_sysbios_family_arm_ducati_GateSmp_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_GateSmp_Module__diagsMask)NULL) ? *ti_sysbios_family_arm_ducati_GateSmp_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_ducati_GateSmp_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_ducati_GateSmp_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_GateSmp_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        ti_sysbios_family_arm_ducati_GateSmp_Params__init__S(prms, NULL, sizeof(ti_sysbios_family_arm_ducati_GateSmp_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
