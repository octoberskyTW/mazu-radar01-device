...
typedef xdc_UInt32 ARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeAddr[4];
typedef xdc_UInt32 CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeAddr[4];
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeAddr __TA_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeAddr;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeXlteAddr;
typedef xdc_UInt32 ARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeXlteAddr[4];
typedef xdc_UInt32 CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeXlteAddr[4];
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeXlteAddr __TA_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largeXlteAddr;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largePolicy;
typedef xdc_UInt32 ARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largePolicy[4];
typedef xdc_UInt32 CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largePolicy[4];
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largePolicy __TA_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__largePolicy;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medAddr;
typedef xdc_UInt32 ARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medAddr[2];
typedef xdc_UInt32 CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medAddr[2];
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medAddr __TA_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medAddr;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medXlteAddr;
typedef xdc_UInt32 ARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medXlteAddr[2];
typedef xdc_UInt32 CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medXlteAddr[2];
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medXlteAddr __TA_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medXlteAddr;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medPolicy;
typedef xdc_UInt32 ARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medPolicy[2];
typedef xdc_UInt32 CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medPolicy[2];
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medPolicy __TA_ti_sysbios_family_arm_ducati_smp_Power_ContextAMMU__medPolicy;
...
typedef struct { int length; ti_sysbios_family_arm_ducati_smp_Power_SuspendFuncHookPtr *elem; } ARRAY1_ti_sysbios_family_arm_ducati_smp_Power_preSuspendHooks;
typedef struct { int length; ti_sysbios_family_arm_ducati_smp_Power_SuspendFuncHookPtr const *elem; } CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_preSuspendHooks;
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_preSuspendHooks __TA_ti_sysbios_family_arm_ducati_smp_Power_preSuspendHooks;
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_preSuspendHooks CT__ti_sysbios_family_arm_ducati_smp_Power_preSuspendHooks;
...
typedef struct { int length; ti_sysbios_family_arm_ducati_smp_Power_SuspendFuncHookPtr *elem; } ARRAY1_ti_sysbios_family_arm_ducati_smp_Power_postSuspendHooks;
typedef struct { int length; ti_sysbios_family_arm_ducati_smp_Power_SuspendFuncHookPtr const *elem; } CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_postSuspendHooks;
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_postSuspendHooks __TA_ti_sysbios_family_arm_ducati_smp_Power_postSuspendHooks;
typedef CARRAY1_ti_sysbios_family_arm_ducati_smp_Power_postSuspendHooks CT__ti_sysbios_family_arm_ducati_smp_Power_postSuspendHooks;
...
static inline xdc_Bool ti_sysbios_family_arm_ducati_smp_Power_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_arm_ducati_smp_Power_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_smp_Power_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_ducati_smp_Power_Module_getMask(void)
{
    return (ti_sysbios_family_arm_ducati_smp_Power_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_smp_Power_Module__diagsMask)NULL) ? *ti_sysbios_family_arm_ducati_smp_Power_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_ducati_smp_Power_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_ducati_smp_Power_Module__diagsMask__C != (CT__ti_sysbios_family_arm_ducati_smp_Power_Module__diagsMask)NULL) {
