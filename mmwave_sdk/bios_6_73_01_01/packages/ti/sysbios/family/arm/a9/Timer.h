...
struct ti_sysbios_family_arm_a9_Timer_Struct {
    ...
    xdc_UInt32 f3;
    ti_sysbios_interfaces_ITimer_PeriodType f4;
    xdc_UInt f5;
    xdc_UInt8 f6;
    xdc_UArg f7;
...
struct ti_sysbios_family_arm_a9_Timer_Fxns__ {
    ...
    xdc_UInt32 (*getMaxTicks)(ti_sysbios_family_arm_a9_Timer_Handle inst);
    xdc_Void (*setNextTick)(ti_sysbios_family_arm_a9_Timer_Handle inst, xdc_UInt32 ticks);
    xdc_Void (*start)(ti_sysbios_family_arm_a9_Timer_Handle inst);
    xdc_Void (*stop)(ti_sysbios_family_arm_a9_Timer_Handle inst);
    xdc_Void (*setPeriod)(ti_sysbios_family_arm_a9_Timer_Handle inst, xdc_UInt32 period);
    xdc_Bool (*setPeriodMicroSecs)(ti_sysbios_family_arm_a9_Timer_Handle inst, xdc_UInt32 microsecs);
    xdc_UInt32 (*getPeriod)(ti_sysbios_family_arm_a9_Timer_Handle inst);
    xdc_UInt32 (*getCount)(ti_sysbios_family_arm_a9_Timer_Handle inst);
    xdc_Void (*getFreq)(ti_sysbios_family_arm_a9_Timer_Handle inst, xdc_runtime_Types_FreqHz* freq);
    ti_sysbios_interfaces_ITimer_FuncPtr (*getFunc)(ti_sysbios_family_arm_a9_Timer_Handle inst, xdc_UArg* arg);
    xdc_Void (*setFunc)(ti_sysbios_family_arm_a9_Timer_Handle inst, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg);
    xdc_Void (*trigger)(ti_sysbios_family_arm_a9_Timer_Handle inst, xdc_UInt32 cycles);
    xdc_UInt32 (*getExpiredCounts)(ti_sysbios_family_arm_a9_Timer_Handle inst);
    xdc_UInt32 (*getExpiredTicks)(ti_sysbios_family_arm_a9_Timer_Handle inst, xdc_UInt32 tickPeriod);
    xdc_UInt32 (*getCurrentTick)(ti_sysbios_family_arm_a9_Timer_Handle inst, xdc_Bool save);
...
__extern xdc_Int ti_sysbios_family_arm_a9_Timer_Instance_init__E(ti_sysbios_family_arm_a9_Timer_Object *obj, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_family_arm_a9_Timer_Params *prms, xdc_runtime_Error_Block *eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_family_arm_a9_Timer_Instance_finalize__E, "ti_sysbios_family_arm_a9_Timer_Instance_finalize")
__extern void ti_sysbios_family_arm_a9_Timer_Instance_finalize__E(ti_sysbios_family_arm_a9_Timer_Object *obj, int ec);

/* create */
xdc__CODESECT(ti_sysbios_family_arm_a9_Timer_create, "ti_sysbios_family_arm_a9_Timer_create")
__extern ti_sysbios_family_arm_a9_Timer_Handle ti_sysbios_family_arm_a9_Timer_create( xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_family_arm_a9_Timer_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_family_arm_a9_Timer_construct, "ti_sysbios_family_arm_a9_Timer_construct")
__extern void ti_sysbios_family_arm_a9_Timer_construct(ti_sysbios_family_arm_a9_Timer_Struct *obj, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_family_arm_a9_Timer_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr ti_sysbios_family_arm_a9_Timer_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb );
...
static inline ti_sysbios_family_arm_a9_Timer_Handle ti_sysbios_family_arm_a9_Timer_Handle_downCast(ti_sysbios_interfaces_ITimer_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&ti_sysbios_family_arm_a9_Timer_Module__FXNS__C) ? (ti_sysbios_family_arm_a9_Timer_Handle)i : (ti_sysbios_family_arm_a9_Timer_Handle)NULL;
}
...
static inline xdc_Bool ti_sysbios_family_arm_a9_Timer_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_family_arm_a9_Timer_Module__diagsMask__C != (CT__ti_sysbios_family_arm_a9_Timer_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_a9_Timer_Module_getMask(void)
{
    return (ti_sysbios_family_arm_a9_Timer_Module__diagsMask__C != (CT__ti_sysbios_family_arm_a9_Timer_Module__diagsMask)NULL) ? *ti_sysbios_family_arm_a9_Timer_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_a9_Timer_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_a9_Timer_Module__diagsMask__C != (CT__ti_sysbios_family_arm_a9_Timer_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        ti_sysbios_family_arm_a9_Timer_Params__init__S(prms, NULL, sizeof(ti_sysbios_family_arm_a9_Timer_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
