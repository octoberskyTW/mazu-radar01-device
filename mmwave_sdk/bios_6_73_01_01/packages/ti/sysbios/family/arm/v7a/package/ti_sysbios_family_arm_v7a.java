...
public class ti_sysbios_family_arm_v7a
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7a.aea8fnv',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7a.aer5f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7a.aer4f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7a.aa8fg',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7a.aa9fg',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7a.aa15fg',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.v7a.aa53fg',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7a.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7a.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7a.aer4f', {target: 'ti.targets.arm.elf.R4F', suffix: 'er4f'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7a.aa8fg', {target: 'gnu.targets.arm.A8F', suffix: 'a8fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7a.aa9fg', {target: 'gnu.targets.arm.A9F', suffix: 'a9fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7a.aa15fg', {target: 'gnu.targets.arm.A15F', suffix: 'a15fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.v7a.aa53fg', {target: 'gnu.targets.arm.A53F', suffix: 'a53fg'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
