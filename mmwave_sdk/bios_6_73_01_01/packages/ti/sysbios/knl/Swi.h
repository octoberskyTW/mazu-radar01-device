...
typedef ti_sysbios_knl_Queue_Instance_State *ARRAY1_ti_sysbios_knl_Swi_Module_State__readyQ;
typedef const ti_sysbios_knl_Queue_Instance_State *CARRAY1_ti_sysbios_knl_Swi_Module_State__readyQ;
