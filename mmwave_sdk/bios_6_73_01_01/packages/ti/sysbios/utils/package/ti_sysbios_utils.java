...
public class ti_sysbios_utils
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae28FP',\n");
            sb.append("'lib/debug/ti.sysbios.utils.a28L',\n");
            sb.append("'lib/debug/ti.sysbios.utils.a28FP',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae430X',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ar430XS',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae66',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae66e',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aearp32',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aearp32F',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae9',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aea8fnv',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aer5f',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aer4f',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aer4ft',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aem3',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aem4',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aem4f',\n");
            sb.append("'lib/debug/ti.sysbios.utils.am33f',\n");
            sb.append("'lib/debug/ti.sysbios.utils.am3g',\n");
            sb.append("'lib/debug/ti.sysbios.utils.am4g',\n");
            sb.append("'lib/debug/ti.sysbios.utils.am4fg',\n");
            sb.append("'lib/debug/ti.sysbios.utils.am33fg',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aa8fg',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aa9fg',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aa15fg',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aa53fg',\n");
            sb.append("'lib/debug/ti.sysbios.utils.arm3',\n");
            sb.append("'lib/debug/ti.sysbios.utils.arm4',\n");
            sb.append("'lib/debug/ti.sysbios.utils.arm4f',\n");
            sb.append("'lib/debug/ti.sysbios.utils.arm33',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae71',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae28FP', {target: 'ti.targets.elf.C28_float', suffix: 'e28FP'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.a28L', {target: 'ti.targets.C28_large', suffix: '28L'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.a28FP', {target: 'ti.targets.C28_float', suffix: '28FP'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ar430XS', {target: 'iar.targets.msp430.MSP430X_small', suffix: 'r430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aearp32', {target: 'ti.targets.arp32.elf.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aearp32F', {target: 'ti.targets.arp32.elf.ARP32_far', suffix: 'earp32F'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae9', {target: 'ti.targets.arm.elf.Arm9', suffix: 'e9'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aer4f', {target: 'ti.targets.arm.elf.R4F', suffix: 'er4f'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aer4ft', {target: 'ti.targets.arm.elf.R4Ft', suffix: 'er4ft'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.utils.am33f', {target: 'ti.targets.arm.clang.M33F', suffix: 'm33f'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.am3g', {target: 'gnu.targets.arm.M3', suffix: 'm3g'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.utils.am33fg', {target: 'gnu.targets.arm.M33F', suffix: 'm33fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aa8fg', {target: 'gnu.targets.arm.A8F', suffix: 'a8fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aa9fg', {target: 'gnu.targets.arm.A9F', suffix: 'a9fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aa15fg', {target: 'gnu.targets.arm.A15F', suffix: 'a15fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aa53fg', {target: 'gnu.targets.arm.A53F', suffix: 'a53fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.arm3', {target: 'iar.targets.arm.M3', suffix: 'rm3'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.utils.arm33', {target: 'iar.targets.arm.M33', suffix: 'rm33'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae71', {target: 'ti.targets.elf.nda.C71', suffix: 'e71'}],\n");
        sb.append("];\n");
