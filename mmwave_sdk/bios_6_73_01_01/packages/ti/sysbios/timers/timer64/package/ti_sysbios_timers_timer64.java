...
public class ti_sysbios_timers_timer64
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.ae66',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.ae66e',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.ae9',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.aa15fg',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.ae9', {target: 'ti.targets.arm.elf.Arm9', suffix: 'e9'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.aa15fg', {target: 'gnu.targets.arm.A15F', suffix: 'a15fg'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
