...
public class ti_sysbios_timers_dmtimer
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae71',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae66',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae66e',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aearp32',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aearp32F',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae9',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aea8fnv',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aer5f',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aem3',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aem4',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aem4f',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.am3g',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.am4g',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.am4fg',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aa8fg',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aa9fg',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aa15fg',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aa53fg',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae71', {target: 'ti.targets.elf.nda.C71', suffix: 'e71'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aearp32', {target: 'ti.targets.arp32.elf.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aearp32F', {target: 'ti.targets.arp32.elf.ARP32_far', suffix: 'earp32F'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae9', {target: 'ti.targets.arm.elf.Arm9', suffix: 'e9'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aem4', {target: 'ti.targets.arm.elf.M4', suffix: 'em4'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.am3g', {target: 'gnu.targets.arm.M3', suffix: 'm3g'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.am4g', {target: 'gnu.targets.arm.M4', suffix: 'm4g'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aa8fg', {target: 'gnu.targets.arm.A8F', suffix: 'a8fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aa9fg', {target: 'gnu.targets.arm.A9F', suffix: 'a9fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aa15fg', {target: 'gnu.targets.arm.A15F', suffix: 'a15fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aa53fg', {target: 'gnu.targets.arm.A53F', suffix: 'a53fg'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
