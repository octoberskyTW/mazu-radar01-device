...
public class ti_sysbios_timers_gptimer
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.timers.gptimer.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.timers.gptimer.aea8fnv',\n");
            sb.append("'lib/debug/ti.sysbios.timers.gptimer.aa8fg',\n");
            sb.append("'lib/debug/ti.sysbios.timers.gptimer.aa9fg',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.timers.gptimer.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.gptimer.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.gptimer.aa8fg', {target: 'gnu.targets.arm.A8F', suffix: 'a8fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.gptimer.aa9fg', {target: 'gnu.targets.arm.A9F', suffix: 'a9fg'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
