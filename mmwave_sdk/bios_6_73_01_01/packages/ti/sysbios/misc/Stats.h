...
__extern xdc_Void ti_sysbios_misc_Stats_Instance_init__E(ti_sysbios_misc_Stats_Object *obj, const ti_sysbios_misc_Stats_Params *prms);

/* create */
xdc__CODESECT(ti_sysbios_misc_Stats_create, "ti_sysbios_misc_Stats_create")
__extern ti_sysbios_misc_Stats_Handle ti_sysbios_misc_Stats_create( const ti_sysbios_misc_Stats_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_misc_Stats_construct, "ti_sysbios_misc_Stats_construct")
__extern void ti_sysbios_misc_Stats_construct(ti_sysbios_misc_Stats_Struct *obj, const ti_sysbios_misc_Stats_Params *prms);
...
__extern xdc_Ptr ti_sysbios_misc_Stats_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb );
...
static inline xdc_Bool ti_sysbios_misc_Stats_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_misc_Stats_Module__diagsMask__C != (CT__ti_sysbios_misc_Stats_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_misc_Stats_Module_getMask(void)
{
    return (ti_sysbios_misc_Stats_Module__diagsMask__C != (CT__ti_sysbios_misc_Stats_Module__diagsMask)NULL) ? *ti_sysbios_misc_Stats_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_misc_Stats_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_misc_Stats_Module__diagsMask__C != (CT__ti_sysbios_misc_Stats_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        ti_sysbios_misc_Stats_Params__init__S(prms, NULL, sizeof(ti_sysbios_misc_Stats_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
