...
public class ti_sysbios_hal_unicache
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.aem3',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.aem4',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.aem4f',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.am3g',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.am4g',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.am4fg',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.arm3',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.arm4',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.arm4f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.aem4', {target: 'ti.targets.arm.elf.M4', suffix: 'em4'}],\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.am3g', {target: 'gnu.targets.arm.M3', suffix: 'm3g'}],\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.am4g', {target: 'gnu.targets.arm.M4', suffix: 'm4g'}],\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.arm3', {target: 'iar.targets.arm.M3', suffix: 'rm3'}],\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.arm4', {target: 'iar.targets.arm.M4', suffix: 'rm4'}],\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
