...
typedef const struct ti_sysbios_hal_unicache_Cache_Fxns__* ti_sysbios_hal_unicache_Cache_Module;
...
typedef const struct ti_sysbios_hal_unicache_Cache_Module_GateProxy_Fxns__* ti_sysbios_hal_unicache_Cache_Module_GateProxy_Module;
