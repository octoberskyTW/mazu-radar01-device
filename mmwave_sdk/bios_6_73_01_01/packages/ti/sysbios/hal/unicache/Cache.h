...
typedef xdc_UInt32 ARRAY1_ti_sysbios_hal_unicache_Cache_CACHE__Reserved[0x77];
typedef xdc_UInt32 CARRAY1_ti_sysbios_hal_unicache_Cache_CACHE__Reserved[0x77];
typedef CARRAY1_ti_sysbios_hal_unicache_Cache_CACHE__Reserved __TA_ti_sysbios_hal_unicache_Cache_CACHE__Reserved;
...
static inline xdc_Bool ti_sysbios_hal_unicache_Cache_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_hal_unicache_Cache_Module__diagsMask__C != (CT__ti_sysbios_hal_unicache_Cache_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_hal_unicache_Cache_Module_getMask(void)
{
    return (ti_sysbios_hal_unicache_Cache_Module__diagsMask__C != (CT__ti_sysbios_hal_unicache_Cache_Module__diagsMask)NULL) ? *ti_sysbios_hal_unicache_Cache_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_hal_unicache_Cache_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_hal_unicache_Cache_Module__diagsMask__C != (CT__ti_sysbios_hal_unicache_Cache_Module__diagsMask)NULL) {
