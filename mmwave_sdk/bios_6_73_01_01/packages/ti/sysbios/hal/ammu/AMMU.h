...
typedef xdc_Char *ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_ADDR[8];
typedef xdc_Char *CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_ADDR[8];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_ADDR __TA_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_ADDR;
typedef xdc_Char *__T1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_XLTE;
typedef xdc_Char *ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_XLTE[8];
typedef xdc_Char *CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_XLTE[8];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_XLTE __TA_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_XLTE;
typedef xdc_UInt32 __T1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_POLICY;
typedef xdc_UInt32 ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_POLICY[8];
typedef xdc_UInt32 CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_POLICY[8];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_POLICY __TA_ti_sysbios_hal_ammu_AMMU_MMU__LARGE_POLICY;
typedef xdc_Char *__T1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_ADDR;
typedef xdc_Char *ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_ADDR[16];
typedef xdc_Char *CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_ADDR[16];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_ADDR __TA_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_ADDR;
typedef xdc_Char *__T1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_XLTE;
typedef xdc_Char *ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_XLTE[16];
typedef xdc_Char *CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_XLTE[16];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_XLTE __TA_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_XLTE;
typedef xdc_UInt32 __T1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_POLICY;
typedef xdc_UInt32 ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_POLICY[16];
typedef xdc_UInt32 CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_POLICY[16];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_POLICY __TA_ti_sysbios_hal_ammu_AMMU_MMU__MEDIUM_POLICY;
typedef xdc_Char *__T1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_ADDR;
typedef xdc_Char *ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_ADDR[32];
typedef xdc_Char *CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_ADDR[32];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_ADDR __TA_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_ADDR;
typedef xdc_Char *__T1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_XLTE;
typedef xdc_Char *ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_XLTE[32];
typedef xdc_Char *CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_XLTE[32];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_XLTE __TA_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_XLTE;
typedef xdc_UInt32 __T1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_POLICY;
typedef xdc_UInt32 ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_POLICY[32];
typedef xdc_UInt32 CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_POLICY[32];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_POLICY __TA_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_POLICY;
typedef xdc_UInt32 __T1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_MAINT;
typedef xdc_UInt32 ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_MAINT[32];
typedef xdc_UInt32 CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_MAINT[32];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_MAINT __TA_ti_sysbios_hal_ammu_AMMU_MMU__SMALL_MAINT;
typedef xdc_Char *__T1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_ADDR;
typedef xdc_Char *ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_ADDR[32];
typedef xdc_Char *CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_ADDR[32];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_ADDR __TA_ti_sysbios_hal_ammu_AMMU_MMU__LINE_ADDR;
typedef xdc_Char *__T1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_XLTE;
typedef xdc_Char *ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_XLTE[32];
typedef xdc_Char *CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_XLTE[32];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_XLTE __TA_ti_sysbios_hal_ammu_AMMU_MMU__LINE_XLTE;
typedef xdc_UInt32 __T1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_POLICY;
typedef xdc_UInt32 ARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_POLICY[32];
typedef xdc_UInt32 CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_POLICY[32];
typedef CARRAY1_ti_sysbios_hal_ammu_AMMU_MMU__LINE_POLICY __TA_ti_sysbios_hal_ammu_AMMU_MMU__LINE_POLICY;
...
static inline xdc_Bool ti_sysbios_hal_ammu_AMMU_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_hal_ammu_AMMU_Module__diagsMask__C != (CT__ti_sysbios_hal_ammu_AMMU_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_hal_ammu_AMMU_Module_getMask(void)
{
    return (ti_sysbios_hal_ammu_AMMU_Module__diagsMask__C != (CT__ti_sysbios_hal_ammu_AMMU_Module__diagsMask)NULL) ? *ti_sysbios_hal_ammu_AMMU_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_hal_ammu_AMMU_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_hal_ammu_AMMU_Module__diagsMask__C != (CT__ti_sysbios_hal_ammu_AMMU_Module__diagsMask)NULL) {
