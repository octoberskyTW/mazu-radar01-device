...
set MMWAVE_SDK_INSTALL_PATH=%MMWAVE_SDK_TOOLS_INSTALL_PATH%/mmwave_sdk_03_04_00_03/packages
@REM TI ARM compiler
...
@REM awr68xx/iwr68xx radarss firmware
set XWR68XX_RADARSS_IMAGE_BIN=%MMWAVE_SDK_INSTALL_PATH%/../firmware/radarss/xwr6xxx_radarss_rprc.bin
