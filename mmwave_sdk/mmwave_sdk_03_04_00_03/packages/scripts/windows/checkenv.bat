...
set devices_str=awr14xx, awr16xx, awr18xx, awr68xx, iwr14xx, iwr16xx, iwr18xx or iwr68xx
...
@echo For Example:
@echo   set MMWAVE_SDK_INSTALL_PATH=C:/ti/mmwave_sdk_03_04_00_03/packages
goto fail
)
...
@echo For Example:
@echo   set C674_CODEGEN_INSTALL_PATH=C:/ti/ti-cgt-c6000_8.3.3
goto fail
)
...
if [%MMWAVE_SDK_DEVICE_TYPE%] == [xwr68xx] (
    ...
    @echo For Example:
    @echo   set XWR68XX_RADARSS_IMAGE_BIN=%MMWAVE_SDK_INSTALL_PATH%/../firmware/radarss/xwr6xxx_radarss_rprc.bin
    goto fail
    )
