...
# Unit Test Files
###################################################################################
MMWAVELIB_DSS_TEST_CFG      = test/dss.cfg
MMWAVELIB_DSS_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)

MMWAVELIB_UNIT_TEST_MAP		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_dss.map
MMWAVELIB_UNIT_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_dss.$(C674_EXE_EXT)
...
MMWAVELIB_FLOAT_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_float.$(C674_EXE_EXT)
