...
# Unit Test Files
###################################################################################
MMWAVELIB_aoaEstFlt_TEST_CFG      = test/dss.cfg
MMWAVELIB_aoaEstFlt_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)

MMWAVELIB_aoaEstFlt_TEST_MAP		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_aoaEstFlt.map
MMWAVELIB_aoaEstFlt_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_aoaEstFlt.$(C674_EXE_EXT)
