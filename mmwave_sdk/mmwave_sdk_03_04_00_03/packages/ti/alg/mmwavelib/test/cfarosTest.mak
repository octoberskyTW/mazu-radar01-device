...
MMWAVELIB_CFAROS_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)

MMWAVELIB_CFAROS_TEST_MAP		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_cfaros.map
MMWAVELIB_CFAROS_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_cfaros.$(C674_EXE_EXT)
