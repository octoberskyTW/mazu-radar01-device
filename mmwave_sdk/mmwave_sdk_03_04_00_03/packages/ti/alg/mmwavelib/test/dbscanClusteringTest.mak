...
# Unit Test Files
###################################################################################
MMWAVELIB_dbscanClustering_TEST_CFG      = test/dss.cfg
MMWAVELIB_dbscanClustering_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)

MMWAVELIB_dbscanClustering_TEST_MAP		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_dbscanClustering.map
MMWAVELIB_dbscanClustering_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_dbscanClustering.$(C674_EXE_EXT)
