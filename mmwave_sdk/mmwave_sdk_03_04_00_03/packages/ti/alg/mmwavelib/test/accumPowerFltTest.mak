...
# Unit Test Files
###################################################################################
MMWAVELIB_accumPowerFlt_TEST_CFG      = test/dss.cfg
MMWAVELIB_accumPowerFlt_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)

MMWAVELIB_accumPowerFlt_TEST_MAP		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_accumPowerFlt.map
MMWAVELIB_accumPowerFlt_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_accumPowerFlt.$(C674_EXE_EXT)
