...
# Unit Test Files
###################################################################################
MMWAVELIB_winCoefGen_TEST_CFG      = test/dss.cfg
MMWAVELIB_winCoefGen_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)
...
MMWAVELIB_winCoefGen_TEST_OUT    = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_winCoefGen.$(C674_EXE_EXT)
