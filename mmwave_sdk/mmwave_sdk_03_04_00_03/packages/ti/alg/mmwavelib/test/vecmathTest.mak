...
MMWAVELIB_VECMATH_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)

MMWAVELIB_VECMATH_TEST_MAP		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_vecmath.map
MMWAVELIB_VECMATH_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_vecmath.$(C674_EXE_EXT)
...
vecmathClean:
	...
	@rm -f $(MMWAVELIB_VECMATH_TEST_OBJECTS) $(MMWAVELIB_VECMATH_TEST_OUT) $(MMWAVELIB_VECMATH_TEST_DEPENDS)
