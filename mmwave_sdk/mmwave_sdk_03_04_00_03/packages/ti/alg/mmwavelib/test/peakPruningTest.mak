...
# Unit Test Files
###################################################################################
MMWAVELIB_peakPruning_TEST_CFG      = test/dss.cfg
MMWAVELIB_peakPruning_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)
...
MMWAVELIB_peakPruning_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_peakPruning.$(C674_EXE_EXT)
