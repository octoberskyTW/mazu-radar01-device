...
# Unit Test Files
###################################################################################
MMWAVELIB_dftSingleBin_TEST_CFG      = test/dss.cfg
MMWAVELIB_dftSingleBin_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)
...
MMWAVELIB_dftSingleBin_TEST_OUT    = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_dftSingleBin.$(C674_EXE_EXT)
