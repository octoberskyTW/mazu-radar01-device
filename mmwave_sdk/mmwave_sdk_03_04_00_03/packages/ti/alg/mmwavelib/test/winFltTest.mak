...
# Unit Test Files
###################################################################################
MMWAVELIB_winFlt_TEST_CFG      = test/dss.cfg
MMWAVELIB_winFlt_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)

MMWAVELIB_winFlt_TEST_MAP		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_windowFlt.map
MMWAVELIB_winFlt_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_windowFlt.$(C674_EXE_EXT)
