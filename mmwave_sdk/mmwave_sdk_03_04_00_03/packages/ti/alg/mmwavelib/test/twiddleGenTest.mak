...
# Unit Test Files
###################################################################################
MMWAVELIB_twiddleGen_TEST_CFG      = test/dss.cfg
MMWAVELIB_twiddleGen_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)
...
MMWAVELIB_twiddleGen_TEST_OUT    = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_twiddleGen.$(C674_EXE_EXT)
