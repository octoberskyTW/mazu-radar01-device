...
# Unit Test Files
###################################################################################
MMWAVELIB_cfarcaFlt_TEST_CFG      = test/dss.cfg
MMWAVELIB_cfarcaFlt_TEST_CONFIGPKG = test/dss_configPkg_$(MMWAVE_SDK_DEVICE_TYPE)

MMWAVELIB_cfarcaFlt_TEST_MAP		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_cfarcaFlt.map
MMWAVELIB_cfarcaFlt_TEST_OUT		 = test/$(MMWAVE_SDK_DEVICE_TYPE)_mmwavealg_cfarcaFlt.$(C674_EXE_EXT)
