...
/**
 *  \file dfptest_config_008.c
 *
 *  \brief This test configures different report modes, different number
 *  of RX/TX channels for some monitors and different RF bandwith for some
 *  monitors
 */
...
dfpTestMiscCfg_t gTestMiscCfg_008 =
{
...
dfpTestStartStopCfg_t gTestStartStopCfg_008 =
{
    .numStartStopNoReconfig = 2,
    .numStartStopReconfig = 3,
    .testNumberSwitchAfterStop[0] = 2,
    .testNumberSwitchAfterStop[1] = 8,
    .testNumberSwitchAfterStop[2] = 2
};
...
rlAdcOutCfg_t adcOutCfgArgs_008 =
{
...
rlLowPowerModeCfg_t lowPowerModeCfg_008 =
{
    .reserved  = 0x0,
    .lpAdcMode = LP_ADC_MODE_LOW_POWER,
};

rlDevHsiClk_t deviceHsiClk_008 =
{
    .hsiClk = 9,
    .reserved = 0x0,
};

rlProfileCfg_t  profileCfg_008[DFPTEST_MAX_NUM_PROFCFG] =
{
    {
        .profileId = 0,
        .pfVcoSelect = 0x0,
...
rlChirpCfg_t  chirpCfg_008[DFPTEST_MAX_NUM_CHIRPCFG] =
{
    {
        .chirpStartIdx = 0,
        .chirpEndIdx = 255U,
...
rlMonDigEnables_t monDigEnables_008 =
{
...
rlDigMonPeriodicConf_t monDigPeriodicCfg_008 =
{
    .reportMode = 0,
    .periodicEnableMask = 0xD
};    

rlMonAnaEnables_t monAnaEnables_008 = /*enable all analog monitors*/
{
...
rlRxSatMonConf_t rxSatMonCfg_008 =
{
    .profileIndx   = 0U,
    .satMonSel     = 3U,
    .reserved0     = 0U,
...
rlSigImgMonConf_t sigImgMonCfg_008 =
{
    .profileIndx = 0U,
    .numSlices   = CQ_NUM_SLICES,
...
rlRfCalMonTimeUntConf_t calMonTimeUnitConf_008 =
{
    .calibMonTimeUnit = 2,
    .numOfCascadeDev = 1,
    .devId = 1,
...
rlRfCalMonFreqLimitConf_t freqLimit_008 =
{
    .freqLimitLow = 760,
    .freqLimitHigh = 810,
    .reserved0 = 0,
...
rlRfInitCalConf_t rfInitCalib_008 =
{
...
rlRunTimeCalibConf_t runTimeCalib_008 =
{
...
rlAdvFrameCfg_t advFrameCfg_008 =
{
...
rlBpmCommonCfg_t bpmCommonCfg_008 =
{
    .mode.b2SrcSel = 0,
    .mode.b1Reserved0 = 0,
    .mode.b13Reserved1 = 0,
...
rlBpmChirpCfg_t bpmChirpCfg_008[DFPTEST_MAX_NUM_BPMCHIRPCFG] =
{
    {
        .chirpStartIdx = 0,
        .chirpEndIdx = 0,
...
rlContModeCfg_t contModeCfg_008 =
{
...
rlContModeEn_t contModeEn_008 =
{
    .contModeEn = 1,
    .reserved   = 0
};

rlDynPwrSave_t dynPwrSave_008 =
{
    .blkCfg   = 0x7,
    .reserved = 0
};

rlGpAdcCfg_t gpAdcCfg_008 =
{
    .enable = 0x3F,
    .bufferEnable = 0x3F,
...
rlRfLdoBypassCfg_t rfLdoBypassCfg_008 =
{
    .ldoBypassEnable   = 1,
    .supplyMonIrDrop   = 0,
    .ioSupplyIndicator = 0,
...
rlTempMonConf_t tempMonCfg_008 =
{
...
rlRxGainPhaseMonConf_t rxGainPhaseMonCfg_008 =
{
    .profileIndx = 0,
    .rfFreqBitMask = 1,
...
rlRxNoiseMonConf_t rxNoiseMonCfg_008 =
{
    .profileIndx = 0,//profileCfg.profileId,
    .rfFreqBitMask = 1,//due to current bug this needs to match rfFreqBitMask in rxGainPhaseMonCfg
    .reserved0 = 0x0,
    .reportMode = MON_REPORT_MODE_AT_FAILURE_ONLY,
    .reserved1 = 0x0,
    .noiseThresh = 350,
...
rlRxIfStageMonConf_t monRxIfStageCfg_008 =
{
    .profileIndx = 1,
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .reserved0 = 0,
...
rlTxPowMonConf_t tx0PowMonCfg_008 =
{
    .profileIndx = 0x1,
    .rfFreqBitMask = 0x1,
    .reserved0 = 0x0,
...
rlTxPowMonConf_t tx1PowMonCfg_008 =
{
    .profileIndx = 0x0,
    .rfFreqBitMask = 0x3,
    .reserved0 = 0x0,
...
rlTxPowMonConf_t tx2PowMonCfg_008 =
{
    .profileIndx = 0x1,
    .rfFreqBitMask = 0x7,
    .reserved0 = 0x0,
...
rlAllTxPowMonConf_t allTxPowMonCfg_008 =
{
    .tx0PowrMonCfg = &tx0PowMonCfg_008,
    .tx1PowrMonCfg = &tx1PowMonCfg_008,
    .tx2PowrMonCfg = &tx2PowMonCfg_008,
};

rlTxBallbreakMonConf_t tx0BallBreakMonCfg_008 =
{
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .reserved0 = 0x0,
...
rlTxBallbreakMonConf_t tx1BallBreakMonCfg_008 =
{
    .reportMode = MON_REPORT_MODE_PERIODIC_WITHOUT_THRESHOLD_CHECK,
    .reserved0 = 0x0,
    .txReflCoeffMagThresh = -70,
...
rlTxBallbreakMonConf_t tx2BallBreakMonCfg_008 =
{
    .reportMode = MON_REPORT_MODE_AT_FAILURE_ONLY,
    .reserved0 = 0x0,
    .txReflCoeffMagThresh = -70,
...
rlAllTxBallBreakMonCfg_t allTxBallbreakMonCfg_008 =
{
    .tx0BallBrkMonCfg = &tx0BallBreakMonCfg_008,
    .tx1BallBrkMonCfg = &tx1BallBreakMonCfg_008,
    .tx2BallBrkMonCfg = &tx2BallBreakMonCfg_008,
};

rlTxGainPhaseMismatchMonConf_t txGainPhMisMatchMonCfg_008 =
{
    .profileIndx = 0x0,
    .rfFreqBitMask = 1,//HIGHEST_CENTER_LOWEST_RF_FRQ_IN_PROFILES_SWEEP_BW,
    .txEn = 0x3,
    .rxEn = 0xF,
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .reserved0  = 0x0,
...
rlTxBpmMonConf_t tx0BpmMonCfg_008 =
{
    .profileIndx = 0x0,
...
rlTxBpmMonConf_t tx1BpmMonCfg_008 =
{
    .profileIndx = 0x0,
    .phaseShifterMonCnfg = 0xC2,
    .phaseShifterMon1 = 0x06,
...
rlTxBpmMonConf_t tx2BpmMonCfg_008 =
{
    .profileIndx = 0x0,
    .phaseShifterMonCnfg = 0xC2,
    .phaseShifterMon1 = 0x06,
...
rlAllTxBpmMonConf_t allTxBpmMonCfg_008 =
{
    .tx0BpmMonCfg = &tx0BpmMonCfg_008,
    .tx1BpmMonCfg = &tx1BpmMonCfg_008,
    .tx2BpmMonCfg = &tx2BpmMonCfg_008,
};

rlSynthFreqMonConf_t synthFreqMonCfg_008 =
{
    .profileIndx = 1,
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .freqErrThresh = 2000,
...
rlExtAnaSignalsMonConf_t extAnaSigMonCfg_008 =
{
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .reserved0 = 0,
...
rlTxIntAnaSignalsMonConf_t tx0IntAnaSigMonCfg_008 =
{
    .profileIndx = 1,
...
rlTxIntAnaSignalsMonConf_t tx1IntAnaSigMonCfg_008 =
{
    .profileIndx = 1,
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,/*mode zero not allowed for this monitor*/
    .reserved0 = 0,
...
rlTxIntAnaSignalsMonConf_t tx2IntAnaSigMonCfg_008 =
{
    .profileIndx = 0,
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,/*mode zero not allowed for this monitor*/
    .reserved0 = 0,
...
rlAllTxIntAnaSignalsMonConf_t allTxanaSigMonCfg_008 =
{
    .tx0IntAnaSgnlMonCfg = &tx0IntAnaSigMonCfg_008,
    .tx1IntAnaSgnlMonCfg = &tx1IntAnaSigMonCfg_008,
    .tx2IntAnaSgnlMonCfg = &tx2IntAnaSigMonCfg_008,
};

rlRxIntAnaSignalsMonConf_t rxIntAnaSigMonCfg_008 =
{
    .profileIndx = 1,
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,/*mode zero not allowed for this monitor*/
    .reserved0 = 0,
...
rlPmClkLoIntAnaSignalsMonConf_t pmClkLoIntAnaSigMonCfg_008 =
{
    .profileIndx = 0,
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,/*mode zero not allowed for this monitor*/
    .sync20GSigSel = 0,
...
rlGpadcIntAnaSignalsMonConf_t gpadcIntAnaSigMonCfg_008 =
{
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .reserved0 = 0,
    .reserved1 = 0,
...
rlPllContrVoltMonConf_t pllConVoltMonCfg_008 =
{
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .reserved0 = 0,
    .signalEnables = 7,
...
rlDualClkCompMonConf_t dualClkCompMonCfg_008 =
{
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .reserved0 = 10,
    .dccPairEnables = 63,
...
rlRxMixInPwrMonConf_t rxMixInpwrMonCfg_008 =
{
    .profileIndx = 0,
    .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
    .txEnable = 3,
...
rlRfProgFiltConf_t progFiltCfg_008 =
{
    .profileId = 0,
    .coeffStartIdx = 0,
    .progFiltLen = 14,
...
rlRfProgFiltCoeff_t progFiltCoef_008 =
{
    .coeffArray[0] = -876,
    .coeffArray[1] = -272,
    .coeffArray[2] = 1826,
...
rlSubFrameStartCfg_t subFrameTrigCfg_008 =
{
    .startCmd = 1,
    .reserved = 0,
};

rlRfMiscConf_t miscCfg_008 = 
{
    .miscCtl  = 1,
    .reserved = 0,
};

rlRfPhaseShiftCfg_t phaseShiftCfg_008[DFPTEST_MAX_NUM_PHASESHCFG] = 
{
    {
        .chirpStartIdx = 0,
        .chirpEndIdx   = 255,
...
rlDynPerChirpPhShftCfg_t dynPhaseShiftCfg_008[DFPTEST_MAX_NUM_DYNPHASESHCFG] = 
{
    {
        .reserved     = 0,
        .chirpSegSel  = 0,
...
rlInterRxGainPhConf_t interRxGainPhCfg_008 = 
{
    .profileIndx     = 0,
    .reserved0       = 0,
    .reserved1       = 1,
...
rlTestSource_t testSourceCfg_008 = 
{
...
rlTestSourceEnable_t testSourceEn_008 = 
{
    .tsEnable  = 1,
    .reserved  = 0,
};

rlRxGainTempLutReadReq_t rxGainTempLutReadCfg_008 = 
{
    .profileIndx   = 0,
    .reserved0     = 0,
    .reserved1     = 0,
...
rlTxGainTempLutReadReq_t txGainTempLutReadCfg_008 = 
{
    .profileIndx   = 0,
    .reserved0     = 0,
    .reserved1     = 0,
...
{
    memcpy((void*)&gTestStartStopCfg     , (void*)&gTestStartStopCfg_008      , sizeof(gTestStartStopCfg));
    memcpy((void*)&gTestMiscCfg          , (void*)&gTestMiscCfg_008           , sizeof(gTestMiscCfg));
    memcpy((void*)&chCfg                 , (void*)&chCfg_008                  , sizeof(chCfg          ));
    memcpy((void*)&adcOutCfgArgs         , (void*)&adcOutCfgArgs_008          , sizeof(adcOutCfgArgs  ));
    memcpy((void*)&lowPowerModeCfg       , (void*)&lowPowerModeCfg_008        , sizeof(lowPowerModeCfg));
    memcpy((void*)&deviceHsiClk          , (void*)&deviceHsiClk_008           , sizeof(deviceHsiClk   ));
    memcpy((void*)&profileCfg[0]         , (void*)&profileCfg_008[0]          , sizeof(rlProfileCfg_t)*DFPTEST_MAX_NUM_PROFCFG);
    memcpy((void*)&chirpCfg[0]           , (void*)&chirpCfg_008[0]            , sizeof(rlChirpCfg_t)*DFPTEST_MAX_NUM_CHIRPCFG);
    memcpy((void*)&monDigEnables         , (void*)&monDigEnables_008          , sizeof(monDigEnables     ));
    memcpy((void*)&monDigPeriodicCfg     , (void*)&monDigPeriodicCfg_008      , sizeof(monDigPeriodicCfg     ));
    memcpy((void*)&monAnaEnables         , (void*)&monAnaEnables_008          , sizeof(monAnaEnables     ));
    memcpy((void*)&rxSatMonCfg           , (void*)&rxSatMonCfg_008            , sizeof(rxSatMonCfg       ));
    memcpy((void*)&sigImgMonCfg          , (void*)&sigImgMonCfg_008           , sizeof(sigImgMonCfg      ));
    memcpy((void*)&frameCfg              , (void*)&frameCfg_008               , sizeof(frameCfg          ));
    memcpy((void*)&calMonTimeUnitConf    , (void*)&calMonTimeUnitConf_008     , sizeof(calMonTimeUnitConf));
    memcpy((void*)&freqLimit             , (void*)&freqLimit_008              , sizeof(freqLimit         ));
    memcpy((void*)&rfInitCalib           , (void*)&rfInitCalib_008            , sizeof(rfInitCalib       ));
    memcpy((void*)&runTimeCalib          , (void*)&runTimeCalib_008           , sizeof(runTimeCalib      ));
    memcpy((void*)&advFrameCfg           , (void*)&advFrameCfg_008            , sizeof(advFrameCfg       ));
    memcpy((void*)&bpmCommonCfg          , (void*)&bpmCommonCfg_008           , sizeof(bpmCommonCfg      ));
    memcpy((void*)&bpmChirpCfg[0]        , (void*)&bpmChirpCfg_008[0]         , sizeof(rlBpmChirpCfg_t)*DFPTEST_MAX_NUM_BPMCHIRPCFG);   
    memcpy((void*)&contModeCfg           , (void*)& contModeCfg_008           , sizeof(contModeCfg           ));
    memcpy((void*)&contModeEn            , (void*)& contModeEn_008            , sizeof(contModeEn            ));
    memcpy((void*)&dynPwrSave            , (void*)& dynPwrSave_008            , sizeof(dynPwrSave            ));
    memcpy((void*)&gpAdcCfg              , (void*)& gpAdcCfg_008              , sizeof(gpAdcCfg              ));
    memcpy((void*)&rfLdoBypassCfg        , (void*)& rfLdoBypassCfg_008        , sizeof(rfLdoBypassCfg        ));
    memcpy((void*)&tempMonCfg            , (void*)& tempMonCfg_008            , sizeof(tempMonCfg            ));
    memcpy((void*)&rxGainPhaseMonCfg     , (void*)& rxGainPhaseMonCfg_008     , sizeof(rxGainPhaseMonCfg     ));
    memcpy((void*)&rxNoiseMonCfg         , (void*)& rxNoiseMonCfg_008         , sizeof(rxNoiseMonCfg         ));
    memcpy((void*)&monRxIfStageCfg       , (void*)& monRxIfStageCfg_008       , sizeof(monRxIfStageCfg       ));
    memcpy((void*)&tx0PowMonCfg          , (void*)& tx0PowMonCfg_008          , sizeof(tx0PowMonCfg          ));
    memcpy((void*)&tx1PowMonCfg          , (void*)& tx1PowMonCfg_008          , sizeof(tx1PowMonCfg          ));
    memcpy((void*)&tx2PowMonCfg          , (void*)& tx2PowMonCfg_008          , sizeof(tx2PowMonCfg          ));
    memcpy((void*)&allTxPowMonCfg        , (void*)& allTxPowMonCfg_008        , sizeof(allTxPowMonCfg        ));
    memcpy((void*)&tx0BallBreakMonCfg    , (void*)& tx0BallBreakMonCfg_008    , sizeof(tx0BallBreakMonCfg    ));
    memcpy((void*)&tx1BallBreakMonCfg    , (void*)& tx1BallBreakMonCfg_008    , sizeof(tx1BallBreakMonCfg    ));
    memcpy((void*)&tx2BallBreakMonCfg    , (void*)& tx2BallBreakMonCfg_008    , sizeof(tx2BallBreakMonCfg    ));
    memcpy((void*)&allTxBallbreakMonCfg  , (void*)& allTxBallbreakMonCfg_008  , sizeof(allTxBallbreakMonCfg  ));
    memcpy((void*)&txGainPhMisMatchMonCfg, (void*)& txGainPhMisMatchMonCfg_008, sizeof(txGainPhMisMatchMonCfg));
    memcpy((void*)&tx0BpmMonCfg          , (void*)& tx0BpmMonCfg_008          , sizeof(tx0BpmMonCfg          ));
    memcpy((void*)&tx1BpmMonCfg          , (void*)& tx1BpmMonCfg_008          , sizeof(tx1BpmMonCfg          ));
    memcpy((void*)&tx2BpmMonCfg          , (void*)& tx2BpmMonCfg_008          , sizeof(tx2BpmMonCfg          ));
    memcpy((void*)&allTxBpmMonCfg        , (void*)& allTxBpmMonCfg_008        , sizeof(allTxBpmMonCfg        ));
    memcpy((void*)&synthFreqMonCfg       , (void*)& synthFreqMonCfg_008       , sizeof(synthFreqMonCfg       ));
    memcpy((void*)&extAnaSigMonCfg       , (void*)& extAnaSigMonCfg_008       , sizeof(extAnaSigMonCfg       ));
    memcpy((void*)&tx0IntAnaSigMonCfg    , (void*)& tx0IntAnaSigMonCfg_008    , sizeof(tx0IntAnaSigMonCfg    ));
    memcpy((void*)&tx1IntAnaSigMonCfg    , (void*)& tx1IntAnaSigMonCfg_008    , sizeof(tx1IntAnaSigMonCfg    ));
    memcpy((void*)&tx2IntAnaSigMonCfg    , (void*)& tx2IntAnaSigMonCfg_008    , sizeof(tx2IntAnaSigMonCfg    ));
    memcpy((void*)&allTxanaSigMonCfg     , (void*)& allTxanaSigMonCfg_008     , sizeof(allTxanaSigMonCfg     ));
    memcpy((void*)&rxIntAnaSigMonCfg     , (void*)& rxIntAnaSigMonCfg_008     , sizeof(rxIntAnaSigMonCfg     ));
    memcpy((void*)&pmClkLoIntAnaSigMonCfg, (void*)& pmClkLoIntAnaSigMonCfg_008, sizeof(pmClkLoIntAnaSigMonCfg));
    memcpy((void*)&gpadcIntAnaSigMonCfg  , (void*)& gpadcIntAnaSigMonCfg_008  , sizeof(gpadcIntAnaSigMonCfg  ));
    memcpy((void*)&pllConVoltMonCfg      , (void*)& pllConVoltMonCfg_008      , sizeof(pllConVoltMonCfg      ));
    memcpy((void*)&dualClkCompMonCfg     , (void*)& dualClkCompMonCfg_008     , sizeof(dualClkCompMonCfg     ));
    memcpy((void*)&rxMixInpwrMonCfg      , (void*)& rxMixInpwrMonCfg_008      , sizeof(rxMixInpwrMonCfg      ));
    memcpy((void*)&progFiltCfg           , (void*)& progFiltCfg_008           , sizeof(progFiltCfg           ));
    memcpy((void*)&progFiltCoef          , (void*)& progFiltCoef_008          , sizeof(progFiltCoef          ));
    memcpy((void*)&subFrameTrigCfg       , (void*)& subFrameTrigCfg_008       , sizeof(subFrameTrigCfg       ));
    memcpy((void*)&miscCfg               , (void*)& miscCfg_008               , sizeof(miscCfg               ));    
    memcpy((void*)&phaseShiftCfg[0]      , (void*)&phaseShiftCfg_008[0]       , sizeof(rlRfPhaseShiftCfg_t)*DFPTEST_MAX_NUM_PHASESHCFG);
    memcpy((void*)&dynPhaseShiftCfg[0]   , (void*)&dynPhaseShiftCfg_008[0]    , sizeof(rlDynPerChirpPhShftCfg_t)*DFPTEST_MAX_NUM_DYNPHASESHCFG);
    memcpy((void*)&interRxGainPhCfg      , (void*)&interRxGainPhCfg_008       , sizeof(interRxGainPhCfg    ));
    memcpy((void*)&testSourceCfg         , (void*)&testSourceCfg_008          , sizeof(testSourceCfg       ));
    memcpy((void*)&testSourceEn          , (void*)&testSourceEn_008           , sizeof(testSourceEn        ));
    memcpy((void*)&rxGainTempLutReadCfg  , (void*)&rxGainTempLutReadCfg_008   , sizeof(rxGainTempLutReadCfg));
    memcpy((void*)&txGainTempLutReadCfg  , (void*)&txGainTempLutReadCfg_008   , sizeof(txGainTempLutReadCfg));
}
