...
{
    {
        ...
        .pfVcoSelect = 0x0,
        .pfCalLutUpdate = 0x0,
        .startFreqConst = PROFILE_START_FREQ_VAL_76_024GHz,
        .idleTimeConst = PROFILE_IDLE_TIME_VAL_16_98us,
        .adcStartTimeConst = PROFILE_ADC_START_TIME_VAL,
        .rampEndTime = PROFILE_RAMP_END_TIME_VAL_67_04us,
        .txOutPowerBackoffCode = PROFILE_TXOUT_POWER_BACKOFF,
        .txPhaseShifter = PROFILE_TXPHASESHIFTER_VAL,
        .freqSlopeConst = PROFILE_FREQ_SLOPE_VAL_14001k,
        .txStartTime = PROFILE_TX_START_TIME_VAL_1us,
        .numAdcSamples = 64,
        .digOutSampleRate = 6500, /* 6.5MHz */
        .hpfCornerFreq1 = CHIRP_HPF1_CORNER_FREQ_350K,
        .hpfCornerFreq2 = CHIRP_HPF2_CORNER_FREQ_350K,
        .txCalibEnCfg = 0x0,
        .rxGain = 48,
        .reserved = 0x0
    },
    {
        ...
        .pfCalLutUpdate = 0x0,
        .startFreqConst = PROFILE_START_FREQ_VAL_76_024GHz,
        .idleTimeConst = PROFILE_IDLE_TIME_VAL_89_41us,
        .adcStartTimeConst = PROFILE_ADC_START_TIME_VAL,
        .rampEndTime = PROFILE_RAMP_END_TIME_VAL_67_04us,
        .txOutPowerBackoffCode = PROFILE_TXOUT_POWER_BACKOFF,
        .txPhaseShifter = PROFILE_TXPHASESHIFTER_VAL,
    ...
    },
    {
        ...
        .pfVcoSelect = 0x0,
        .pfCalLutUpdate = 0x0,
        .startFreqConst = PROFILE_START_FREQ_VAL_76_5GHz,
        .idleTimeConst = PROFILE_IDLE_TIME_VAL_89_41us,
        .adcStartTimeConst = PROFILE_ADC_START_TIME_VAL,
        .rampEndTime = PROFILE_RAMP_END_TIME_VAL_67_04us,
        .txOutPowerBackoffCode = PROFILE_TXOUT_POWER_BACKOFF,
