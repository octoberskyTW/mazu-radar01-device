...
#define _LIBCXX_USE_RAW_CLOCK_TIME
#else
#define _LIBCXX_USE_CLOCK_GETTIME
#endif // __APPLE__
...
#if !defined(_LIBCXX_USE_RAW_CLOCK_TIME)
#include <sys/time.h>        // for gettimeofday and timeval
#endif // !defined(_LIBCXX_USE_RAW_CLOCK_TIME)
...
#include <mach/mach_time.h>  // mach_absolute_time, mach_timebase_info_data_t
      ...
      !defined(_LIBCXX_USE_RAW_CLOCK_TIME)
...
#elif defined(_LIBCXX_USE_RAW_CLOCK_TIME)
    return time_point(seconds(time(NULL)));
#else
    timeval tv;
    gettimeofday(&tv, 0);
...
steady_clock::now() _NOEXCEPT
{
    return time_point(seconds((time_t)(clock() / CLOCKS_PER_SEC)));
}
