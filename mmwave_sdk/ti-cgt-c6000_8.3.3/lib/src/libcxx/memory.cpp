...
// Disable this mutex that is used for atomc<shared_ptr> until we
// enable thread/mute support.
#if !defined(_LIBCPP_HAS_NO_ATOMIC_HEADER) && !defined(__TI_COMPILER_VERSION__)
