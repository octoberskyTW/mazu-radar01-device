...
ios_base::copyfmt(const ios_base& rhs)
{
    ...
    unique_ptr<event_callback, void (*)(void*)> new_callbacks(0, _LIBCPP_FREE);
    unique_ptr<int, void (*)(void*)> new_ints(0, _LIBCPP_FREE);
    unique_ptr<long, void (*)(void*)> new_longs(0, _LIBCPP_FREE);
    unique_ptr<void*, void (*)(void*)> new_pointers(0, _LIBCPP_FREE);
